...
class SyncClosureTests(unittest.TestCase):
    ...
    def test_refresh_generated_runs_builders_before_audits(self):
        ...
        self.assertLess(names.index("build relation index"), names.index("build relation candidates"))
        self.assertLess(names.index("build relation candidates"), names.index("build discovery index"))
        ...
        self.assertLess(names.index("build discovery index"), names.index("build output gallery and navigation"))
