...
2026-09-15，接续REV-093；上一阶段已同步至cd62698。本轮七名人物按姓名、创作对象、地域、年代与职业语境完成专业来源初步身份核对，补入可支持的字段。不是七篇人物百科补足完成，也未进行Wiki双向验证。下列网页均实际阅读；来源之间不按网站数量推定独立性。

| 对象 | 实际读取与采纳 | 限制及交接 |
|---|---|---|
| Domenico Cerato | Treccani短条目完整正文；建筑及教学身份、1715–1792、Padua去世及1765起教学，与A. Memmo整治Prato della Valle；A. Memmo按既有Andrea Memmo对象及同一整治项目对应 | Mason出生地仅“可能”，不转确定出生关系；未将市内教学推定为大学任职。Torlonga天文台、民用医院及1784建筑著述是后续具名端点；当前只采纳本书广场项目及人物生涯事实 |
| Guido Ubaldo Abbatini | DBI第1卷（1960）Carla Faldi Guglielmi传记及附列书目全文；生卒地点、短期师承Cesari、与Bernini及Romanelli的明确合作 | 引用书目原件未读；未把本书卷首图的作者署名细化成刻版职责。Raimondi／Pio／Cornaro装饰、Santo Spirito圣器室、St Peter马赛克及Urban VIII肖像待按具体对象补入；不称作品清单完整 |
| Claude Mellan | Met 28.7.24全部可见对象字段及图注；法国身份、1598 Abbeville–1688 Paris，与书中同名Giustiniani肖像作者对应 | 隐藏Provenance未展开；1631第二状态印本不能直接对应书中未定载体，馆藏号与尺寸未写入原书作品。作品本身的原书创作及肖像人物边已补 |
| Francesco Fanelli | Met 2021.76可见全文、脚注1–19与对象字段；1577 Florence、Genoa家庭作坊、1632赴London获年金、1635王室雕塑家任命 | 范戴克交流仅“possible interchange”，不作合作边；原書Daphne Ionides肖像与注12所记V&A A.3-1999待核。此次V&A搜索未取得对应馆藏详情；搜索出现的Marjorie署名不得替换Daphne。Mercury and Cupid及其他铸本留作作品端点后续核对，不扩写为整套已接收作品 |
| Nicolò Bambini | Macerata Musei 131a完整说明与技术字段；1651–1736、Venetian画派、Venice／Rome受训及1672罗马记录，原书Niccolo作为惯用写法保留 | 131a与图版42b不是同一题材，不改写原书作品。131a由Buonaccorsi委托、1712／约1712–1713交付的具名作品及其题材端点进入后续补足；合作列举不同画家不等于同幅共同创作 |
| Francesco Petrucci | ICCD 0900378126完整网页字段、历史说明及铭文；约1660–1719、Volterrano学生、Ferdinando宫廷复制画家及版画绘图 | 未读附链接PDF；不得混同现代同名学者。0900378126为另一幅复制版画，Petrucci绘图、Verkruys刻制、Veronese原作；不把版画直接当他独立画作或本书费迪南多肖像 |
| Orazio Gentileschi | National Gallery艺术家传记全文；1563–1639、Pisa、Artemisia亲缘及授艺、Caravaggio影响和赴英宫廷履历 | 父亲Giovanni Battista Lomi、兄Aurelio、配偶Prudentia di Montone、Agostino Tassi合作及相关 patron／institution 端点待补；三名儿子未具名不补造。Finding of Moses与Peace ceiling需独立作品核对；Artemisia参与天顶画只作推测，不转确定合作 |

本轮新增Abbeville及Città di Castello两个出生地点KU，只采用人物来源支持的城市粒度，先经全库名称／别名搜索排除已有对象，不扩写城市百科。七张人物卡保留原书摘录及图版作品链接，名称、基本信息、身份、亲缘、教学和履历分别组织；取得身份资料不能冒称完整作品表。

关系逐条由Agent决定：出生／死亡地点分角色；教学、工作、迁居区分；Petrucci的Volterrano与已对齐Franceschini合并为同一端点；亲缘与授艺为两个事实。补查发现Cerato方案与Mellan肖像虽然各有供片边，仍缺创作关系，现补4条原书关系。此前“无出向边为0”不表示这些关系已经齐全。

全部新边清单由本轮可审查exact plan保存并落入相应KU，正文反向展示依词表生成；旧来源与旧正式边保持。9项主候选继续待证；上述后续端点及其余人物、作品、地点来源缺口仍须推进，不缩小总体目标。当前是语义自查，未进行独立或人工验收；未提交推送，未启动知识发现或页面。

## 班比尼馆藏作品与文学来源

2026-09-15继续同轮补足。先完成七人批次36文件exact plan核对：32卡、108条原书摘录、560条本地链接及33条新增关系均通过；14步同步检查完成，关系索引1046条。随后沿Bambini已采纳的Macerata馆方记录建立131a作品，保留1712字段与约1712–1713交付时间，补入媒介、尺寸、陈列部位和文学取材。

网页 https://musei.macerata.it/opera/enea-racconta-a-didone-la-caduta-di-troia/ 全部说明及技术字段已读；同馆 https://musei.macerata.it/opera/galleria-delleneide/ 全部照片说明及技术字段亦已读。后者是历史照片记录，说明1967散藏、1973–1974国家购回四幅画及Solimena作品外流；未说明Bambini131a是否其中一幅，故不为本画复制该购藏链。没有将历史照片当作画廊本体作品或本书所用照片的实物身份。

作品131a与原书42b《威尼斯寓意》是不同对象，既有卡保留。Bambini作品表增加可点击的新作品；图像题材源指向新建archive《埃涅阿斯纪》及既有Virgil。这里只确认文学作品身份和馆方记载的第一卷取材，未读原典正文，也未配对出版版本；不与Mola借阅的题名不明注释本合并，不借此消解第一章旧版本缺口。

正式关系为8条：画作→Bambini创作；画作→画廊原定用途与馆方陈列；画作→《埃涅阿斯纪》取材；文献→Virgil作者；画廊→Raimondo装饰委托、→宫殿空间组成、→Macerata所在城市。原句commissionata修饰Galleria，故不把画廊整体委托直接转换为Raimondo个人订制这张画的单件合同。原定装饰、馆方当前陈列、法律所有权分开，未补无据产权。

Dido／Aeneas／Achates是具体图像角色，按taxonomy-registry现行边界不能临时冒充历史person；本轮在作品内容逐名保留，正式题材端点仍待类型表达裁决。该缺口影响题材关系完整性，不阻断已有作者／用途／陈列及文学来源关系，也不为完成计数偷偷扩类。此前七人阅读发现的其他作品、家庭、机构端点仍按上一节交接。
