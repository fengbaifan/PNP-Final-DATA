...
|---|---|
| person | 人物 |
| family | 以血缘、婚姻、收养及有据历史认同维系的家族与支系；不同于单个人物、姓氏概念或家户组织 |
...
- 人物身份、作品主题、材料、荣衔、金额、时间、断言和证据不能按名词逐一强塞现有类型。可独立讨论的材料/颜色/身份概念可归 term；某批实物、神话图像角色等若现有定义不能忠实表达，记录原文和所缺能力，再判断是否扩类，不默默丢弃或临时冒充 person/work。

## 家族、成员与家户（REV-036）

- family 表示有来源支持的具体家族或支系；人物仍为 person。同姓、同地或同一赞助网络不证明同族，联姻也不自动合并两个家族。支系仅在材料能够区分且有独立表达需要时另建。
- 家户／宫廷随从组织可能包含管家、雇员和艺术家；具组织身份时归 institution，服务关系不等于亲缘或家族成员关系。混合指称先保留明确的范围待决，不整卡强转 family。
- 王朝作为亲缘家系可归 family；国家、政府和统治机构归 institution，爵号或政体名称不自动确定家族身份。个人委托、家族集体赞助及家户活动分别归责。
- 共用元数据不新增专属表头；家族内容范围见 ingest 的 body-template。家族与已有成员可按有据的 member_of 连接，支系归属可用 part_of；适用边界与方向见关系契约，不凭类型迁移自动造边。
