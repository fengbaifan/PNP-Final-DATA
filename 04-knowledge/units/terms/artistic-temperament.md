---
title: "艺术家气质（Artistic temperament）"
name_en: "Artistic temperament"
type: term
created: 2026-09-09
updated: 2026-09-14
evidence_status: source_backed
sources:
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 21, 22.'
  location: 第一章；印刷页 21, 22；OCR L882–893,905–926
  sentence_summary: Vasari、Malvasia、Perugini 与 Rosa 分属不同观念语境，不是同时代共同证言。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 882–893,905–926; print pp. 21, 22
  original_quotes:
  - source_span: "lines 882–893"
    text: |2-
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 22, 23.'
  location: 第一章；印刷页 22, 23；OCR L927–947,952–980
  sentence_summary: 灵感、独立及后世定型为历史观念；不据此作临床诊断。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 927–947,952–980; print pp. 22, 23
  original_quotes:
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-terms-artistic-temperament
---
...
**中文：** 关于艺术家异常性、灵感与独立性的历史观念。本章区别 Vasari 暗示、十七世纪认可、后世固定化，不能当作临床性格诊断。

**English:** Haskell traces ideas about artists' exceptional behaviour and inspiration through Vasari, seventeenth-century examples and later formulations. These are historical representations of temperament, not clinical diagnoses of the people discussed.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Artistic temperament | S1、S2 |
| 性质 | 历史观念与人物评价；非医学诊断 | S1、S2 |

### 补充信息

| 字段 | 当前结论 | 证据边界 |
|---|---|---|
| 中文术语 | 艺术家气质 | 项目规范名；对应第一章语境 |
| 英文／原语 | Artistic temperament；temperament／character相关表述；不同作者用词不可强行同义化 | 不把译名扩大为固定历史术语 |
| 章内操作性定义 | 第一章中由传记作者、代理人和艺术家自述归给画家的性情与行为特征集合，用于分析社会如何解释艺术家的异常、傲慢、忧郁、速度或不服约束。 | 用于理解第一章论证，不预设Topic或Theme |
| 语义证据 | Vasari、Malvasia、Perugini和Rosa书信分别构造不同时代、不同立场的艺术家性格叙述。 | 各发言者、传记作者与Haskell解释分别归责 |
| 排除边界 | 属于历史话语与评价对象，不是临床诊断；不能把不同作者的修辞合成同一事实，也不能由气质推断天才。 | 防止把修辞、分析概念和可验证事件混同 |
