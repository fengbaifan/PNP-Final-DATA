...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 8.'
  ...
  sentence_summary: 移动画可按成对和嵌墙装饰安排尺寸。
  evidence_ref:
...
- citation: "Getty AAT, cabinet pictures (paintings), AAT300033639. https://www.getty.edu/vow/AATFullDisplay?find=&logic=AND&note=&subjectid=300033639. Accessed 2026-09-11."
  location: "完整web规范记录已读，采用英语定义及多语时期差异边界。"
  sentence_summary: "供小收藏室近观的小幅画，通常任一边小于两英尺；板、象牙、金属、布等载体均可。不能把所有gallery pictures缩为cabinet pictures。"
...
**中文：** 本章gallery picture指可以收藏、交易和重新布置的画廊绘画，仍可能为特定室内位置或成对装饰而制作。Getty关于架上画和小型收藏室画的规范定义有助于界定相邻概念，但不能直接替代本章术语。[S1–S6]

**English:** In this chapter, a gallery picture is a movable painting available for collection, exchange or rearrangement, yet it may have been made for a particular interior or paired scheme. Getty definitions of easel paintings and cabinet pictures clarify neighbouring concepts without establishing exact equivalence to the chapter's term. [S1–S6]

### 概念字段

| 字段 | 内容 | 依据 |
|---|---|---|
| 原词／项目译名 | gallery picture／可移动画廊画；中文为语境性译名 | S1–S3 |
| 主要特征 | 可移动、可收藏和交易；不是现代“画廊照片” | S1–S3 |
| 空间要求 | 可能嵌入墙面或为对称位置定制，尺寸和构图仍受装饰方案约束 | S1、S6 |
| 获取方式 | 委托、购入工作室存画、购买被退作品等；各个案例不同 | S2、S3 |
| 对象层次 | term；实际单幅画另属work，不因术语资料而新增实物 | S1–S3 |

### 相邻术语

- **Easel paintings，AAT300177435：** 通常在画架或可移动装置上绘制的布本、板本画；Getty讨论16世纪以来独立收藏价值的语境。“架上制作”与“画廊用途”是不同判断轴，暂不作exact match。[S4]
