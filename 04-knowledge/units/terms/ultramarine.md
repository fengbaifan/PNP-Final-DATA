---
title: "群青（Ultramarine / oltremare）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 13.'
  location: 第一章；印刷页 13；OCR L486–519
  sentence_summary: 本章合同中特别讨论费用承担的颜料。不同委托可由画家或赞助人供应，不设单一成本规则；其他古色名保留在相关材料安排中。
  evidence_ref:
...
- citation: "Wikidata, Q219660, revision 2538804210. https://www.wikidata.org/wiki/Q219660. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "历史天然群青颜料概念；不从现代合成群青或化学标准批次填充原合同。"
- citation: "Wikipedia (en), Ultramarine, revision 1373556039. https://en.wikipedia.org/wiki/Ultramarine. Accessed 2026-09-11."
  location: "全文29760字符，含图注、注释及书目；对象页，不含外链原著"
  sentence_summary: "天然颜料来源、提炼与不同等级；现代合成群青及色值不移植本章。"
- citation: "Wikidata Q219660, revision 2538804210. https://www.wikidata.org/wiki/Q219660. Accessed 2026-09-11."
  location: "双向sitelink及适用字段／rank／限定词／引用；采纳边界见正文"
  sentence_summary: "P279蓝色颜料normal含P248 Q24499814但英中文标签不可得，不能声称该参考已读；采用定义另由馆方支持。"
...
**中文：** 天然群青是从青金石中分离含蓝色矿物成分而制得的颜料；历史上的进口与提炼成本使其成为昂贵材料。本章讨论其供应及费用责任，不同合同安排不同。（S1、S4、S6）

**English:** Natural ultramarine is a pigment obtained by separating the blue mineral component of lapis lazuli. Importation and preparation made it a costly historical material. Haskell discusses who supplied and paid for it, with arrangements varying between commissions. (S1, S4, S6)

### 材料术语字段

| 字段 | 内容 | 依据 |
|---|---|---|
| 名称／原词 | 群青；ultramarine；oltremare，天然型可称oltremare genuino | S1、S4 |
| 对象层次 | 颜料概念；青金石原石、颜料、调入媒介后的颜料层和具体供货批次分开 | S4、S6 |
| 原料 | lapis lazuli青金石；蓝色矿物组分lazurite | S4 |
| 历史制备 | 研磨并分离杂质；不同提取等级影响颜色与价值 | S4 |
| 外观 | 蓝色；不能给所有古代样品统一现代RGB值 | S4 |
| 材料使用 | 可与媒介结合成颜料层；画面位置与用量须靠具体合同或技术分析 | S1、S6 |
| WD父类 | 蓝色颜料Q113587231；normal | S5；支持来源Q24499814本轮未读且英中文标签未取得 |
| 规范库线索 | AAT300013200，仅WD提供，原记录未读 | S5 |

### 历史使用与辨析

National Gallery对1505年《安西代圣母》的研究说明，圣母衣饰最终罩染层使用来自青金石的天然群青。该画媒介检测为核桃油，是该对象的检测结论；不能据此给本章所有群青颜料填写核桃油媒介。（S6）

十九世纪发展合成群青，属于另一期技术背景。百科的现代合成配方、工厂产量、数码色值及商品颜色不移入十七世纪委托记录；蓝色外观本身不足以区分天然、合成或其他蓝颜料。（S4）

原章分别载画家或赞助人承担材料。群青昂贵不等于每幅作品使用同等级、同重量或同价格，也不证明供应来自同一商人。其他历史色名保留，不合并成群青。（S1）
