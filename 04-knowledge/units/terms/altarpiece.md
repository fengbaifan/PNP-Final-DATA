...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 5.'
  location: 第一章；印刷页 5；OCR L101–110
  sentence_summary: 祭坛画作为引介网络中的教堂委托。
  evidence_ref:
...
- citation: "Wikidata, Q15711026, revision 2508628084. https://www.wikidata.org/wiki/Q15711026. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "祭坛后宗教图像／艺术品的通类概念；在本项目为术语，不是独立作品实例。"
- citation: "Wikipedia (en), Altarpiece, revision 1356016219. https://en.wikipedia.org/wiki/Altarpiece. Accessed 2026-09-10."
  location: "全文：定义、沿革、类型、实例、图注及注释／书目；REV-052"
  sentence_summary: "祭坛艺术品的通类、组件、功能和迁移；不直接采纳页面全部历史例证或年代。"
- citation: "Wikidata, Q15711026, revision 2508628084. https://www.wikidata.org/wiki/Q15711026. Accessed 2026-09-10."
  location: "enwiki sitelink、P279、P361、P1014及rank／引用；相关实体标签已读"
  sentence_summary: "AAT 300075940为概念对应；无引用的上位类和part of不自动成为本项目分类或图谱边。"
- citation: "Getty Research Institute, Art & Architecture Thesaurus, altarpieces, 300075940. https://www.getty.edu/vow/AATFullDisplay?find=&logic=AND&note=&page=1&subjectid=300075940. Accessed 2026-09-10."
  location: "完整记录已读取：定义、Terms、层级、关联和来源；实际采用英语定义及适用名称"
  sentence_summary: "概念涵盖祭坛上或后方的绘画／雕刻图像对象；意大利语名称含pala d'altare，类型定义不代表具体作品。"
- citation: "National Gallery, London, Altarpieces, Glossary. https://www.nationalgallery.org.uk/paintings/glossary/altarpieces. Accessed 2026-09-10."
  location: "短词条全文"
  sentence_summary: "供礼拜使用的图像对象，可由绘画和／或雕刻装饰；尺寸结构及叙事方式多样。"
...
**中文：** “祭坛画”在本章主要指为教堂祭坛位置制作的绘画，尺寸、采光、安置和图像主题影响委托。英文altarpiece的通类范围还包括雕刻及绘画与雕刻组合；概念、完整装置与具体构件须分别识别。

**English:** In this chapter, “altarpiece” chiefly refers to paintings made for church altars, whose commissioning is shaped by dimensions, lighting, placement and subject. The broader term also covers sculpture and combinations of painting and sculpture; the concept, complete ensemble and individual components require separate identification.

### 术语与定义

| 字段 | 内容 | 依据 |
|---|---|---|
| 中文名 | 祭坛画；用于本章绘画语境，涉及雕刻组合时注明“祭坛艺术品／装置”范围 | S1–S3及语义判断 |
| 英文 | altarpiece；复数altarpieces；拼写变体altar-piece／altar-pieces | S6、S8 |
| 意大利语 | pala d'altare；复数pale d'altare；不因索引列异名就机械替换所有地方用语 | S8 |
| 定义要点 | 为基督教礼拜空间祭坛配置的图像承载对象，媒材可为绘画、雕刻或组合 | S8、S9 |
| 空间位置 | 祭坛上、后部或后方墙面；既可用于主祭坛也可用于侧祭坛，不统一为“祭坛前方” | S8 |
| 主要作用 | 礼拜视觉焦点；宗教人物或叙事图像可与奉献、纪念及赞助语境结合 | S8、S9 |
| 材质／数量 | 无统一必需材质、尺寸或构件数量；具体对象逐件记录 | S6、S9 |
| 本项目分类 | 本卡为term；具体祭坛绘画、雕塑、画框等按对象边界进入work，不能把概念QID写给作品实例 | 本项目分类判断 |

### 结构与近义边界

| 表达 | 含义／区别 | 依据 |
|---|---|---|
| polyptych／triptych | 多联／三联结构；不是所有祭坛画都具有折翼 | S6 |
| 主板／侧板 | 组合画面不同位置的图像构件，可能对应教堂、奉献者或宗教社群的崇敬对象 | S10 |
| predella | 主层下方的基座／图像带，常有叙事场景；不是整件祭坛画的同义词 | S10 |
| retable／reredos | 与祭坛后方装饰或支承整体有关，用法随地区及研究传统变化；不能当所有具体作品的完全等义名称 | S6 |
| altar／祭坛 | 礼仪设施，与配置的图像作品不同 | S8；S7 P361仅作线索 |
| 教堂与馆藏作品 | 建筑空间、原安置点、拆离作品及后世藏地分别保存，现藏博物馆不抹去原礼拜功能 | S6、S10 |

### 历史范围与本章用法

- 中世纪至近代早期，祭坛艺术品包含多种结构与媒材；巴洛克时期可见大型单一叙事画面或绘画雕塑组合，不预设每件都遵循同一路径。（S6）
- 第一章p.5、L101–110：祭坛画是同乡及教会引介可能带来的委托；一般路径不逐人强套。（S1）
- 第一章pp.8–9、L258–277、288–307：具体尺寸、安置、采光和图像要求影响制作；Guercino的询问是具体案例。（S2）
- 第一章p.11、L397–412：Caravaggio、Rubens、Lanfranco有不同合同／申请条件，不归并成通行统一合同。（S3）

### 研究来源

- Peter、Linda Murray，*The Oxford Companion to Christian Art and Architecture*（1996）：S6书目线索，未读原著。
- Peter Humfrey、Martin Kemp，*The Altarpiece in the Renaissance*（1990）：S6书目线索，未读。
- David Ekserdjian，*The Italian Renaissance Altarpiece: Between Icon and Narrative*（2021）：S6书目线索，未读。
