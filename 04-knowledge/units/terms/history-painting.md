...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 15.'
  location: 第一章；印刷页 15；OCR L603–606
  sentence_summary: Rosa 珍重大幅历史画，而来客可能偏好小画。
  evidence_ref:
...
- citation: "Wikidata, Q742333, revision 2504720274. https://www.wikidata.org/wiki/Q742333. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "按叙事题材定义的历史画类型，含宗教和神话，不限真实历史事件。"
- citation: "Wikipedia (en), History painting, revision 1368550732. https://en.wikipedia.org/wiki/History_painting. Accessed 2026-09-11."
  location: "全文25559字符，含图注、注释及书目；对象页，不含外链原著"
  sentence_summary: "叙事题材含宗教、神话、寓意及历史；门类地位是历史评价，不是本项目等级。"
- citation: "Wikidata Q742333, revision 2504720274. https://www.wikidata.org/wiki/Q742333. Accessed 2026-09-11."
  location: "双向sitelink及适用字段／rank／限定词／引用；采纳边界见正文"
  sentence_summary: "P31绘画类型、P279人物画均normal且未附引用；实际核对标签，P1014仅作规范库线索。"
...
**中文：** 历史画是以严肃叙事、典范行动或寓意为题材的绘画门类，包括圣经、神话、文学及历史事件。这里“历史”不等于真实事件的准确记录。本章以罗萨的创作抱负和学院成员构成讨论其地位。（S1–S2、S5、S7）

**English:** History painting treats serious narratives, exemplary actions or allegories drawn from scripture, mythology, literature and historical events. “History” does not require a documentary account of actual events. Haskell discusses its standing through Rosa’s ambitions and the composition of academy membership. (S1–S2, S5, S7)

### 术语字段

| 字段 | 内容 | 依据 |
|---|---|---|
| 名称 | 历史画；history painting；意大利语istoria为相关叙事概念 | S5、S7 |
| 对象性质 | 绘画门类，非某幅作品或统一画风 | S5–S7 |
| 题材 | 宗教、神话、文学、实际历史及寓意 | S5、S7 |
| 常见形式 | 多人物及较大尺幅常见，但不以面积或人数作绝对门槛 | S5、S7 |
| WD类型 | P31绘画类型Q16743958；P279人物画Q5448026，normal、无引用 | S6，实际标签已核；语义另由S7支持 |
| 权威库线索 | AAT300033898，来自WD，本轮未开该AAT记录 | S6 |

### 历史使用及章内限制

自约十六世纪起，欧洲学院传统常赋予历史画较高地位，并要求综合人物、动作和构图能力。这是特定艺术理论及制度中的评价，不是本项目按艺术价值划定的等级。（S5、S7）

现代英文historical painting有时专指世俗历史题材，与较宽的history painting有区别；历史文献未必严格区分，须按作者时代和上下文解释。（S5）

罗萨珍重大幅作品而来客偏好小画，是本章具名的价值与市场落差；学院早期成员又不排除其他门类。不能从历史画地位推出所有会员都是历史画家，或所有大画均属此类。（S1–S2）
