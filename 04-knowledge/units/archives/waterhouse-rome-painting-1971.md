---
title: 十八世纪罗马绘画（Painting in Rome in the Eighteenth Century）
name_en: Painting in Rome in the Eighteenth Century
type: archive
...
- citation: Crossref DOI registration metadata, 10.2307/4104347. https://api.crossref.org/works/10.2307/4104347.
    Accessed 2026-09-15.
  location: 完整JSON message：title、author、container-title、volume、published-print、page、DOI和resource；未读论文全文
  sentence_summary: Ellis K. Waterhouse，Painting in Rome in the Eighteenth Century，Art Institute of Chicago Museum
    Studies卷6，1971；page字段为6。
created: '2026-09-14'
updated: '2026-09-15'
...
**中文：** 埃利斯·沃特豪斯发表于1971年《芝加哥艺术博物馆研究》第6卷的论文，讨论18世纪罗马绘画。

**English:** An article by Ellis Waterhouse on eighteenth-century Roman painting, published in volume 6 of Art Institute of Chicago Museum Studies in 1971.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Painting in Rome in the Eighteenth Century | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 责任者 | E. K. Waterhouse；[埃利斯·沃特豪斯](../persons/ellis-waterhouse.md) | S1 |
| 刊载期刊 | [博物馆研究期刊](../archives/museum-studies-art-institute-chicago.md) | S1 |
| 出版年 | 1971 | S1 |
| 原书所列页码 | 7–21 | S1 |
| 论争对象 | Wittkower的威尼斯中心论及Haskell的罗马分期 | S2 |

### 外部书目记录

| 字段 | 值 | 证据 |
|---|---|---|
| DOI | [10.2307/4104347](https://doi.org/10.2307/4104347) | S3 |
| 卷次 | 6 | S3 |
| 作者署名 | Ellis K. Waterhouse | S3 |
| Crossref页码字段 | 6 | S3 |
| 出版年份 | 1971 | S3 |
...
[Crossref论文登记](https://api.crossref.org/works/10.2307/4104347)（S3）


### 关系记录
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| ← cited_by（`cited_by`，反向投影） | [《赞助人与画家》（Patrons and Painters）](patrons-and-painters.md) | 角色：第二版导言所引论文；范围：第二版导言所述Waterhouse意见和1971脚注相连；不等于接受其全部论点；原断言与证据见发出端卡片“《赞助人与画家》（Patrons and Painters）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；patrons-and-painters；lines 178–187; 章前：第二版导言；印刷页xvii |
