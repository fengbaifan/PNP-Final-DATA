...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 16.'
  ...
  sentence_summary: Haskell 用其叙事作艺术家异常行为得到宽容的参照；没有在本章列版本，暂不填出版年。
  evidence_ref:
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| → 作者（`authored_by`） | [本韦努托·切利尼（Benvenuto Cellini）](../persons/benvenuto-cellini.md) | 本章明确引用 Cellini 的自传；证据：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 634–635; print pp. 16 |
