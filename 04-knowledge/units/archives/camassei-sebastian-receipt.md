---
title: "卡马塞伊《圣塞巴斯蒂安殉难》的收据刊录（Published Receipt for Camassei's Martyrdom of Saint Sebastian）"
name_en: "Published Receipt for Camassei's Martyrdom of Saint Sebastian"
type: archive
sub_type: receipt
created: 2026-09-09
updated: 2026-09-10
...
**中文：** A. Bertolotti 在 Artisti bolognesi 缩题著作 pp.161–162 刊出的收据，Haskell 用以确定画家为 Camassei。收据不同于相关 1633 材料负担合同；本章未给收据日期，不将合同年份移填。

**English:** A receipt published by A. Bertolotti on pages 161–162 of Artisti bolognesi enables Haskell to identify Camassei as the painter. It is distinct from the 1633 contract concerning materials; the contract's date must not be assigned to this undated receipt.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Published Receipt for Camassei's Martyrdom of Saint Sebastian | S1；标题中的语境说明为登记用语 |
| 载录与版本边界 | Bertolotti，pp.161–162；收据日期未见，区别于 1633 合同 | S1，支持范围见各条句意摘要 |
...
S1：第一章；印刷页 10；OCR L335–338,372–374。编号按文件头 sources 顺序对应。句意摘要是转述；具体条目支持范围以该条的章页／行号为准，不能把一个出处视为整卡全部内容的证明。
