---
title: "格拉西关于科尔托纳与多利亚潘菲利宫画廊草稿的论文（1957）（Grassi's Article on Cortona and the Bozzetti for the Doria Pamphili Gallery (1957)）"
name_en: "Grassi's Article on Cortona and the Bozzetti for the Doria Pamphili Gallery (1957)"
type: archive
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 12.'
  ...
  sentence_summary: 本章用于科尔托纳稿本归属争议。书后书目列题名 Pietro da Cortona e i “bozzetti” per la Galleria di Palazzo Doria Pamphili，载 Bollettino d’Arte，1957，pp.28–43。只核对引文与书目，未读论文全文，不把论文发表当作归属定论。
  evidence_ref:
...
**中文：** 路易吉·格拉西的论文研究彼得罗·达·科尔托纳为多利亚潘菲利宫画廊壁画所作的油画草稿。作者在讨论科尔托纳的装饰性空间语言后，逐一比较壁画与罗马帕特里齐收藏的七件草稿，主张它们约作于1651年末至1652年初并出自科尔托纳本人；这是一项有论证的归属意见，不应转写为无争议事实。（S1–S3）

**English:** Luigi Grassi's article studies oil sketches associated with Pietro da Cortona's frescoes in the Doria Pamphili palace gallery. After framing Cortona's decorative conception of space, Grassi compares the frescoes with seven sketches in the Patrizi collection, dates them to about late 1651–early 1652, and argues that they are autograph works. This remains an argued attribution rather than an uncontested fact. (S1–S3)

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 正式题名 | *Pietro da Cortona e i “bozzetti” per la Galleria di Palazzo Doria Pamphili* | S3题名页 |
| 作者 | Luigi Grassi | S3题名页 |
| 刊载信息 | *Bollettino d’Arte*，ser. IV，42卷1期，1957年1–3月，pp.28–43 | S3；期刊官网目录 |
| 研究对象 | Doria Pamphili宫画廊的《埃涅阿斯纪》题材壁画，以及罗马Patrizi收藏的七件油画bozzetti | S3 pp.34–43 |
| 方法 | 文献史梳理；壁画与草稿逐件图像、构图、笔触和色彩比较 | S3全文 |
| 核心归属意见 | 七件Patrizi草稿是壁画的准备性作品、不是后制摹本，并归于Cortona本人 | S3 pp.34–35；属于作者判断 |
| 年代意见 | 约1651年末至1652年初，即整体构图准备期 | S3 p.34；属于推定 |
