---
title: "里奇 1682 年《施洗者约翰斩首》委托（Ricci’s Beheading of Saint John the Baptist commission (1682)）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 9.'
  ...
  sentence_summary: Bologna 同名善会要求 Ricci 表现斩首场面并加入所需人物；本章支持委托题材，不确认今日流传的具体同题作品版本。
  evidence_ref:
...
- citation: "Gianluca Stefani, Sebastiano Ricci impresario d’opera a Venezia nel primo Settecento (Firenze University Press, 2015), p. 27 n.3. https://tile.loc.gov/storage-services/master/gdc/gdcebookspublic/20/20/71/94/83/2020719483/2020719483.pdf. Accessed 2026-09-11."
  location: "第2章p.27及注3"
  sentence_summary: "确认1682-09-28、Bologna佛罗伦萨人善会和作品失佚；未提供原档号。"
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-ricci-beheading-john-baptist-1682
---
...
**中文：** Bologna 同名善会要求 Ricci 表现斩首场面并加入所需人物；本章支持委托题材，不确认今日流传的具体同题作品版本。

**English:** A Bologna confraternity's 1682 instructions required Ricci to depict the beheading of John the Baptist with the figures needed to express it. The contract reference does not independently identify a specific present-day version.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Ricci’s Beheading of Saint John the Baptist commission (1682) | S1 |
| 委托要求 | Bologna 兄弟会；1682；表现斩首及必要人物 | S1 |

### 作品信息

| 字段 | 当前结论 | 依据／边界 |
|---|---|---|
| 作品名／规范指称 | 《施洗者约翰斩首》（Beheading of Saint John the Baptist） | 精确题名可证时采用；不可证时保留描述性名 |
| 创作者／归属 | Sebastiano Ricci | 争议归属不写成确定事实 |
| 创作／委托时间 | 委托日期1682-09-28 | 区分合同、开工、完成、毁失或后续记录 |
| 委托人／赞助方 | Confraternita di San Giovanni Battista dei Fiorentini, Bologna | 仅写当前证据可支持的法律或历史主体 |
| 创作地／原位置／现位置 | Bologna；原定善会相关空间，作品现已失佚 | 历史位置和现藏不互相覆盖 |
| 类型、材质与尺寸 | 绘画；载体、尺寸和完成形态未见 | 缺项不根据同类作品补推 |
| 状态与语义边界 | 合同规定斩首场面和所需人物；研究资料列为失佚，不能从合同反推完成构图。 | 委托、稿本、完成作品、归属和现藏分别判断 |
