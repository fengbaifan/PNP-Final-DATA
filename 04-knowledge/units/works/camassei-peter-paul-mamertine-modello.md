---
title: "卡马塞伊《圣彼得与圣保罗在马默蒂诺监狱施洗》稿（Camassei’s modello of Saints Peter and Paul baptizing in the Mamertine Prison）"
...
relations:
  ...
  - {"relation_type":"located_at","target":"institutions/pinacoteca-vaticana.md","note":"本书写作时所记馆藏，非今日核验。","evidence_ref":{"doc_id":"patrons-and-painters","source_file":"02-sources/02-Markdown/01_CHP-1.md","source_span":"lines 464–466; print pp. 12"},"review_status":"evidence_backed_relation","relation_source":"explicit","bidirectional_required":false}
sources:
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 12.'
  location: 第一章；印刷页 12；OCR L464–466
  sentence_summary: Waterhouse 向 Haskell 指出此 modello，曾属 Barberini，书中记藏 Pinacoteca Vaticana，编号 820、旧号 539 m。流传和编号只限本书记录时点。
  evidence_ref:
