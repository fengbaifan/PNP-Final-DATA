---
title: 维纳斯与阿多尼斯（Venus and Adonis）
name_en: Venus and Adonis
type: work
...
- relation_type: supplied_by
  ...
  role: 本书复制图像供片者
  scope: 《赞助人与画家》图版39的复制图像；不表示作品创作者、所有者或保管者
---
...
**中文：** 《赞助人与画家》图版39目录所记的《维纳斯与阿多尼斯》艺术对象。

**English:** The art object titled Venus and Adonis, listed as plate 39 in Patrons and Painters.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Venus and Adonis | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| → 由其供应（`supplied_by`） | [佛罗伦萨美术馆监管机构（Soprintendenza alle Gallerie, Florence）](../institutions/soprintendenza-alle-gallerie-florence.md) | 角色：本书复制图像供片者；范围：《赞助人与画家》图版39的复制图像；不表示作品创作者、所有者或保管者；证据：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；patrons-and-painters；lines 170–171; 章前：图片来源；印刷页xvi |
