---
title: 巴德明顿景观（View from Badminton, 1748）
name_en: View from Badminton, 1748
type: work
...
**中文：** 《赞助人与画家》图版51目录所记的《巴德明顿景观》艺术对象。

**English:** The art object titled View from Badminton, 1748, listed as plate 51 in Patrons and Painters.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | View from Badminton, 1748 | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版编号 | 51 | S1 |
| 创作者 | [卡纳莱托](../persons/canaletto.md) | S1 |
| 描绘地点／对象 | [巴德明顿](../places/badminton.md) | S1 |
| 目录年代 | 1748 | S1 |
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| → 由其供应（`supplied_by`） | [皇家艺术研究院（Royal Academy of Arts）](../institutions/royal-academy.md) | 角色：本书复制图像供片者；范围：《赞助人与画家》图版51的复制图像；不表示作品创作者、所有者或保管者；证据：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；haskell-1980-rev-ed；lines 168–169; 章前：图片来源；印刷页xvi |
