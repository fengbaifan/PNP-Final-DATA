---
title: 《圣母之死》（Death of the Virgin）
name_en: Death of the Virgin
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Death of the Virgin归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://en.wikipedia.org/wiki/Death_of_the_Virgin_(Caravaggio)
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 拒收后经曼图亚及英法王室收藏；当前保管与历史所有权分开。
- relation_type: held_by
  target: institutions/louvre-museum.md
  note: 当前对象记录将Death of the Virgin列由该机构保管；保管不自动等于产权。
  evidence_ref:
...
- relation_type: commissioned_by
  target: persons/laerzio-cherubini.md
  note: 来源明确该端点承担Death of the Virgin的委托角色；不由委托推定当前所有权。
  evidence_ref:
    doc_id: commissioned-by-persons-laerzio-cherubini-md
    source_file: https://en.wikipedia.org/wiki/Death_of_the_Virgin_(Caravaggio)
...
- relation_type: intended_for
  target: places/santa-maria-della-scala-rome.md
  note: Death of the Virgin原定用于该建筑或礼拜堂。
  evidence_ref:
    doc_id: intended-for-places-santa-maria-della-scala-rome-md
    source_file: https://en.wikipedia.org/wiki/Death_of_the_Virgin_(Caravaggio)
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第34项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将Death of the Virgin列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), Death of the Virgin (Caravaggio), revision 1365927667. https://en.wikipedia.org/wiki/Death_of_the_Virgin_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分Death of the Virgin的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q597114, https://www.wikidata.org/wiki/Q597114. Accessed 2026-09-12.
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-death-virgin
---
...
**中文：** 《圣母之死》，年代为约1601–1606。现存。

**English:** Death of the Virgin is dated c. 1601–1606. It survives.
