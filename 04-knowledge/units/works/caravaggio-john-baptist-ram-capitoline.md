---
title: 《施洗者约翰与公羊》（Young Saint John the Baptist with a Ram）
name_en: Young Saint John the Baptist with a Ram
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Young Saint John the Baptist with a Ram归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://www.museicapitolini.org/it/node/47105
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 卡拉瓦乔至少八幅施洗者约翰题材作品之一，与博尔盖塞晚期版本分开。
- relation_type: held_by
  target: institutions/capitoline-museums.md
  note: 当前对象记录将Young Saint John the Baptist with a Ram列由该机构保管；保管不自动等于产权。
  evidence_ref:
...
- relation_type: commissioned_by
  ...
  note: 来源明确该端点承担Young Saint John the Baptist with a Ram的委托角色；不由委托推定当前所有权。
  evidence_ref:
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第30项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将Young Saint John the Baptist with a Ram列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), John the Baptist (Caravaggio), revision 1365222349. https://en.wikipedia.org/wiki/John_the_Baptist_(Caravaggio). Accessed 2026-09-12.
  ...
  sentence_summary: 区分Young Saint John the Baptist with a Ram的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q3223625, https://www.wikidata.org/wiki/Q3223625. Accessed 2026-09-12.
...
- citation: Collection or site authority record. https://www.museicapitolini.org/it/node/47105. Accessed 2026-09-12.
  location: 对象字段及与身份、版本、保管、安置或委托有关的说明
  sentence_summary: 为Young Saint John the Baptist with a Ram提供具体对象或安置记录；支持范围以正文逐项注明。
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-john-baptist-ram-capitoline
---
...
**中文：** 《施洗者约翰与公羊》，年代为1602。现存。

**English:** Young Saint John the Baptist with a Ram is dated 1602. It survives.

### 题名、类型与基本信息

| 字段 | 内容 | 依据 |
|---|---|---|
| 中文规范题名 | 《施洗者约翰与公羊》 | S1–S2 |
| 英文规范题名 | Young Saint John the Baptist with a Ram | S2 |
...
- **对象边界：** 卡拉瓦乔至少八幅施洗者约翰题材作品之一，与博尔盖塞晚期版本分开。
- **版本／归属状态：** 现存。
