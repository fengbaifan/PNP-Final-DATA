---
title: 《圣彼得钉十字架》（Crucifixion of Saint Peter）
name_en: Crucifixion of Saint Peter
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Crucifixion of Saint Peter归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://en.wikipedia.org/wiki/Crucifixion_of_Saint_Peter_(Caravaggio)
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 现存布面版本；与1600年合同委托对象卡分开。
- relation_type: installed_at
  target: places/cerasi-chapel.md
  note: 来源将Crucifixion of Saint Peter与该实际或历史安置地点对应。
  evidence_ref:
...
- relation_type: commissioned_by
  ...
  note: 来源明确该端点承担Crucifixion of Saint Peter的委托角色；不由委托推定当前所有权。
  evidence_ref:
...
- relation_type: intended_for
  target: places/cerasi-chapel.md
  note: Crucifixion of Saint Peter原定用于该建筑或礼拜堂。
  evidence_ref:
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第29项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将Crucifixion of Saint Peter列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), Crucifixion of Saint Peter (Caravaggio), revision 1361249053. https://en.wikipedia.org/wiki/Crucifixion_of_Saint_Peter_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分Crucifixion of Saint Peter的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q685916, https://www.wikidata.org/wiki/Q685916. Accessed 2026-09-12.
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-crucifixion-saint-peter
---
...
**中文：** 《圣彼得钉十字架》，年代为1601。现存。

**English:** Crucifixion of Saint Peter is dated 1601. It survives.

### 题名、类型与基本信息

| 字段 | 内容 | 依据 |
|---|---|---|
| 中文规范题名 | 《圣彼得钉十字架》 | S1–S2 |
| 英文规范题名 | Crucifixion of Saint Peter | S2 |
...
| 尺寸 | 230 cm × 175 cm (91 in × 69 in) | S2 |
| 当前保管／状态 | 现存；现存 | S2–S4 |
| 馆藏标识 | 未取得可安全采用的单一馆藏号 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 现存布面版本；与1600年合同委托对象卡分开。
- **版本／归属状态：** 现存。
