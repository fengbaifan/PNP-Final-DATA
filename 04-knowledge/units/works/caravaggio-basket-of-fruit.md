---
title: 《果篮》（Basket of Fruit）
name_en: Basket of Fruit
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Basket of Fruit归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://www.ambrosiana.it/en/opere/basket-of-fruit/
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 年代在研究中有1596至1601等不同判断，本卡不压成无争议精确年。
- relation_type: held_by
  target: institutions/pinacoteca-ambrosiana.md
  note: 当前对象记录将Basket of Fruit列由该机构保管；保管不自动等于产权。
  evidence_ref:
    doc_id: held-by-institutions-pinacoteca-ambrosiana-md
    source_file: https://www.ambrosiana.it/en/opere/basket-of-fruit/
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第1项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将Basket of Fruit列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), Basket of Fruit (Caravaggio), revision 1365210988. https://en.wikipedia.org/wiki/Basket_of_Fruit_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分Basket of Fruit的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q2270291, https://www.wikidata.org/wiki/Q2270291. Accessed 2026-09-12.
...
- citation: Collection or site authority record. https://www.ambrosiana.it/en/opere/basket-of-fruit/. Accessed 2026-09-12.
  location: 对象字段及与身份、版本、保管、安置或委托有关的说明
  sentence_summary: 为Basket of Fruit提供具体对象或安置记录；支持范围以正文逐项注明。
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-basket-of-fruit
---
...
**English:** Basket of Fruit is dated c. 1599. It survives.
...
| 尺寸 | 46 cm × 64.5 cm (18 in × 25.4 in) | S2 |
| 当前保管／状态 | 安布罗西亚纳画廊／Pinacoteca Ambrosiana；现存 | S2–S4 |
| 馆藏标识 | 151 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 年代在研究中有1596至1601等不同判断，本卡不压成无争议精确年。
- **版本／归属状态：** 现存。
