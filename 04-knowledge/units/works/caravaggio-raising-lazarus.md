---
title: 《拉撒路复活》（The Raising of Lazarus）
name_en: The Raising of Lazarus
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将The Raising of Lazarus归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://en.wikipedia.org/wiki/The_Raising_of_Lazarus_(Caravaggio)
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 为墨西拿拉扎里礼拜堂相关委托；当前馆藏在墨西拿区域博物馆。
- relation_type: held_by
  target: institutions/regional-museum-messina.md
  note: 当前对象记录将The Raising of Lazarus列由该机构保管；保管不自动等于产权。
  evidence_ref:
...
- relation_type: commissioned_by
  target: persons/giovanni-battista-de-lazzari.md
  note: 来源明确该端点承担The Raising of Lazarus的委托角色；不由委托推定当前所有权。
  evidence_ref:
    doc_id: commissioned-by-persons-giovanni-battista-de-lazzari-md
    source_file: https://en.wikipedia.org/wiki/The_Raising_of_Lazarus_(Caravaggio)
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第43项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将The Raising of Lazarus列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), The Raising of Lazarus (Caravaggio), revision 1374407664. https://en.wikipedia.org/wiki/The_Raising_of_Lazarus_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分The Raising of Lazarus的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q2277635, https://www.wikidata.org/wiki/Q2277635. Accessed 2026-09-12.
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-raising-lazarus
---
...
**English:** The Raising of Lazarus is dated 1609. It survives.
...
|---|---|---|
| 中文规范题名 | 《拉撒路复活》 | S1–S2 |
| 英文规范题名 | The Raising of Lazarus | S2 |
