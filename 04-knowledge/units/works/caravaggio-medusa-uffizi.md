---
title: 《美杜莎》（乌菲齐版本）（Medusa (Uffizi version)）
name_en: Medusa (Uffizi version)
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Medusa (Uffizi version)归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
  ...
  role: 创作者
  scope: 绘于盾牌形载体；与较小的Murtola版本分开。
- relation_type: held_by
  target: institutions/uffizi-gallery.md
  note: 当前对象记录将Medusa (Uffizi version)列由该机构保管；保管不自动等于产权。
  evidence_ref:
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  ...
  sentence_summary: 主页面将Medusa (Uffizi version)列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), Medusa (Caravaggio), revision 1361282398. https://en.wikipedia.org/wiki/Medusa_(Caravaggio). Accessed 2026-09-12.
  ...
  sentence_summary: 区分Medusa (Uffizi version)的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q2293905, https://www.wikidata.org/wiki/Q2293905. Accessed 2026-09-12.
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-medusa-uffizi
---
...
**中文：** 《美杜莎》（乌菲齐版本），年代为约1597–1598。现存。

**English:** Medusa (Uffizi version) is dated c. 1597–1598. It survives.

### 题名、类型与基本信息

| 字段 | 内容 | 依据 |
|---|---|---|
| 中文规范题名 | 《美杜莎》（乌菲齐版本） | S1–S2 |
| 英文规范题名 | Medusa (Uffizi version) | S2 |
| 作品类型 | 绘画；具体载体与版本见下 | S2–S4（如有） |
| 创作者／归属 | 米开朗基罗·梅里西·达·卡拉瓦乔／Michelangelo Merisi da Caravaggio | S2–S4 |
| 创作年代 | 约1597–1598 | S1–S4 |
| 媒介与材质 | 布面油画，装裱于凸面杨木盾牌（oil on canvas mounted on a convex poplar shield） | S2–S4（如有） |
| 尺寸 | 60 cm × 55 cm (24 in × 22 in) | S2 |
| 当前保管／状态 | 乌菲齐美术馆／Uffizi Gallery；现存 | S2–S4 |
| 馆藏标识 | 1890 no. 1351 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 绘于盾牌形载体；与较小的Murtola版本分开。
- **版本／归属状态：** 现存。
