---
title: 《圣马太蒙召》（The Calling of Saint Matthew）
name_en: The Calling of Saint Matthew
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将The Calling of Saint Matthew归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://en.wikipedia.org/wiki/The_Calling_of_Saint_Matthew
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: Wikidata的1609年项与作品史不合，本卡采用页面与礼拜堂资料的1599–1600。
- relation_type: installed_at
  target: places/contarelli-chapel.md
  note: 来源将The Calling of Saint Matthew与该实际或历史安置地点对应。
  evidence_ref:
...
- relation_type: intended_for
  target: places/contarelli-chapel.md
  note: The Calling of Saint Matthew原定用于该建筑或礼拜堂。
  evidence_ref:
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第22项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将The Calling of Saint Matthew列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), The Calling of Saint Matthew, revision 1368373413. https://en.wikipedia.org/wiki/The_Calling_of_Saint_Matthew. Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分The Calling of Saint Matthew的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q969377, https://www.wikidata.org/wiki/Q969377. Accessed 2026-09-12.
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-calling-saint-matthew
---
...
**中文：** 《圣马太蒙召》，年代为约1599–1600。现存。

**English:** The Calling of Saint Matthew is dated c. 1599–1600. It survives.
...
|---|---|---|
| 中文规范题名 | 《圣马太蒙召》 | S1–S2 |
| 英文规范题名 | The Calling of Saint Matthew | S2 |
...
| 尺寸 | 322 cm × 340 cm (127 in × 130 in) | S2 |
| 当前保管／状态 | 现存；现存 | S2–S4 |
| 馆藏标识 | 未取得可安全采用的单一馆藏号 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** Wikidata的1609年项与作品史不合，本卡采用页面与礼拜堂资料的1599–1600。
- **版本／归属状态：** 现存。
