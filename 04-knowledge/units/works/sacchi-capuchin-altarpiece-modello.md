---
title: "萨基罗马嘉布遣会教堂祭坛稿（Sacchi’s modello for a Roman Capuchin church altarpiece）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 12.'
  ...
  sentence_summary: 本章所记 Sacchi 的一幅 modello，1961 年 5–6 月经 London Colnaghi’s（目录号 2），后在 Denis Mahon 藏中；未列题材，不补猜。
  evidence_ref:
...
- citation: "National Galleries of Scotland, Saint Anthony of Padua reviving a Dead Man, NG 2854. https://www.nationalgalleries.org/art-and-artists/44597. Accessed 2026-09-11."
  location: "web读取对象页About this artwork和全套对象字段；requests直取403，未用错误页作证；作品图像未作目视分析"
  sentence_summary: "馆方给约1635年、木板油画、110.70×76.20厘米、2012年Mahon信托经Art Fund捐赠；认定为1633–34祭坛画的缩小复制品。"
...
### 描述
**中文：** 本章以“嘉布遣会教堂祭坛画稿”提及的萨基小幅画，可通过Colnaghi1961年目录号2对应《圣安东尼复活死者》。后来的图录及苏格兰国家美术馆将它判断为缩小复制品；哈斯克尔的“稿”称法保留为来源时期的判断，不能覆盖现有版本辨析。[S1–S3]
**English:** Sacchi's small painting described in the chapter as a Capuchin altarpiece modello can be connected, through Colnaghi's 1961 catalogue no. 2, with Saint Anthony of Padua reviving a Dead Man. The later catalogue and the National Galleries of Scotland identify it as a reduced replica. Haskell's designation is retained as a historical interpretation rather than treated as a settled version classification. [S1–S3]

### 名称与对象
| 字段 | 内容 | 依据 |
|---|---|---|
| 识别题名 | 《圣安东尼复活死者》／Saint Anthony of Padua reviving a Dead Man | S2–S3；中文暂译，指Padua的Anthony |
| 原登记名 | 萨基罗马嘉布遣会教堂祭坛稿；固定路径保留以连接本章措辞 | S1 |
| 创作者 | Andrea Sacchi | S1–S4 |
| 对象类型 | 小幅绘画，现馆方归为缩小复制品 | S3 |
| 辨认链 | Sacchi＋Colnaghi1961 no.2＋Mahon收藏，与1997图录no.70相接；尺寸再与馆号核对 | S1–S3；本项目据这些字段判断对应 |
| 相关大型原作 | 罗马Santa Maria della Concezione教堂1633–1634年祭坛画，非本卡110.7厘米对象 | S2–S3 |
| 创作年代／地点 | 约1635；未核本小幅画的具体工作地点 | S3 |
| 材质 | 木板油画 | S3 |
| 尺寸 | 画面110.70×76.20厘米；带框132.00×98.20×7.70厘米 | S3；长宽与带框数据不混用 |

### 内容、版本与赞助
画面主题为基督教圣徒传说：圣安东尼使死者复生作证，帮助洗清父亲的罪名；不把所绘神迹登记为已核史实。[S3]

1997年图录以构图高度相符及缺乏显著修改等理由，反对预备稿判断；这是有依据的版本意见。该条把大型祭坛画委托者归为**年长安东尼奥·巴贝里尼（1569–1646）**，而小幅画为谁制作仍属推测。因此不新增小安东尼奥为本件委托人的关系。[S2]

### 流传与保管
| 时间 | 事项 | 依据 |
|---|---|---|
| 1961年5–6月 | London Colnaghi目录no.2 | S1、S2 |
| 哈斯克尔所用记录时期 | Denis Mahon收藏 | S1；不能直接当今天私藏 |
| 2012年 | Mahon慈善信托受托人经Art Fund捐赠 | S3 |
| 当前馆方对象记录 | National Galleries of Scotland，NG2854；网页标National展示，陈列状态随时间变化 | S3；2026-09-11访问 |
| 更早来源 | 本轮未核原清册，不把可能的Barberini库存对应写成确定所有权 | S2阅读范围 |
