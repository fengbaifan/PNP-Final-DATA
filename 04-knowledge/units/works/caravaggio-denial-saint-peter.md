---
title: 《圣彼得不认主》（The Denial of Saint Peter）
name_en: The Denial of Saint Peter
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将The Denial of Saint Peter归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://en.wikipedia.org/wiki/The_Denial_of_Saint_Peter_(Caravaggio)
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 晚期作品；当前馆号1997.167。
- relation_type: held_by
  target: institutions/metropolitan-museum-of-art.md
  note: 当前对象记录将The Denial of Saint Peter列由该机构保管；保管不自动等于产权。
  evidence_ref:
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第46项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将The Denial of Saint Peter列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), The Denial of Saint Peter (Caravaggio), revision 1361321961. https://en.wikipedia.org/wiki/The_Denial_of_Saint_Peter_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分The Denial of Saint Peter的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q2270778, https://www.wikidata.org/wiki/Q2270778. Accessed 2026-09-12.
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-denial-saint-peter
---
...
**中文：** 《圣彼得不认主》，年代为约1610。现存。

**English:** The Denial of Saint Peter is dated c. 1610. It survives.
...
|---|---|---|
| 中文规范题名 | 《圣彼得不认主》 | S1–S2 |
| 英文规范题名 | The Denial of Saint Peter | S2 |
...
| 尺寸 | 94 cm × 125.4 cm (37 in × 49.4 in) | S2 |
| 当前保管／状态 | 大都会艺术博物馆／Metropolitan Museum of Art；现存 | S2–S4 |
| 馆藏标识 | 1997.167 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 晚期作品；当前馆号1997.167。
- **版本／归属状态：** 现存。
