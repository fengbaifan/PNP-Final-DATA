---
title: 海神向威尼斯致敬（Neptune paying homage to Venice）
name_en: Neptune paying homage to Venice
type: work
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 《赞助人与画家》图版42a目录所记的《海神向威尼斯致敬》艺术对象。
  original_quotes:
...
- citation: MUVE, Neptune Offering Gifts to Venice. https://www.visitmuve.it/en/masterpiece/giambattista-tiepolo-neptune-offering-gifts-to-venice/.
    Accessed 2026-09-14.
...
| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Neptune paying homage to Venice | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 书中位置 | [总督宫（威尼斯）](../places/palazzo-ducale.md) | S1 |
| 书中位置 | [威尼斯](../places/venice.md) | S1 |
| 图像题材 | Neptune、Venice拟人 | S1 |

### 身份与版本字段

| 字段 | 值 | 证据 |
|---|---|---|
| 馆方题名 | 海神向威尼斯献礼／Neptune Offering Gifts to Venice | S2 |
| 馆方创作年代 | 1757–1758 | S2 |
| 材质 | 布面油画／Oil on canvas | S2 |
| 馆藏编号 | TS 2° p. n. 6 n. 328 | S2 |
...
| 字段 | 链接 | 范围 |
|---|---|---|
| 机构记录 | [Author、Date、Museum、Technique、Inventory](https://www.visitmuve.it/en/masterpiece/giambattista-tiepolo-neptune-offering-gifts-to-venice/) | 本次身份／版本依据，S2 |
