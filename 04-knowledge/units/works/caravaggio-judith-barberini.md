---
title: 《朱迪斯斩杀赫罗弗尼斯》（巴贝里尼宫版本）（Judith Beheading Holofernes (Palazzo Barberini version)）
name_en: Judith Beheading Holofernes (Palazzo Barberini version)
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Judith Beheading Holofernes (Palazzo Barberini version)归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://www.barberinicorsini.org/en/opera/judith-beheading-holofernes/
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 与2014年在图卢兹发现的争议对象分开。
- relation_type: held_by
  target: institutions/galleria-nazionale-arte-antica.md
  note: 当前对象记录将Judith Beheading Holofernes (Palazzo Barberini version)列由该机构保管；保管不自动等于产权。
  evidence_ref:
    doc_id: held-by-institutions-galleria-nazionale-arte-antica-md
    source_file: https://www.barberinicorsini.org/en/opera/judith-beheading-holofernes/
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
...
- relation_type: installed_at
  ...
  note: 来源将Judith Beheading Holofernes (Palazzo Barberini version)与该实际或历史安置地点对应。
  evidence_ref:
    doc_id: installed-at-places-palazzo-barberini-md
    source_file: https://www.barberinicorsini.org/en/opera/judith-beheading-holofernes/
...
- relation_type: commissioned_by
  target: persons/ottavio-costa.md
  note: 来源明确该端点承担Judith Beheading Holofernes (Palazzo Barberini version)的委托角色；不由委托推定当前所有权。
  evidence_ref:
    doc_id: commissioned-by-persons-ottavio-costa-md
    source_file: https://www.barberinicorsini.org/en/opera/judith-beheading-holofernes/
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第15项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将Judith Beheading Holofernes (Palazzo Barberini version)列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), Judith Beheading Holofernes (Caravaggio), revision 1371602996. https://en.wikipedia.org/wiki/Judith_Beheading_Holofernes_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分Judith Beheading Holofernes (Palazzo Barberini version)的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q2470123, https://www.wikidata.org/wiki/Q2470123. Accessed 2026-09-12.
...
- citation: Collection or site authority record. https://www.barberinicorsini.org/en/opera/judith-beheading-holofernes/. Accessed 2026-09-12.
  location: 对象字段及与身份、版本、保管、安置或委托有关的说明
  sentence_summary: 为Judith Beheading Holofernes (Palazzo Barberini version)提供具体对象或安置记录；支持范围以正文逐项注明。
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-judith-barberini
---
...
**中文：** 《朱迪斯斩杀赫罗弗尼斯》（巴贝里尼宫版本），年代为约1599–1602。现存。

**English:** Judith Beheading Holofernes (Palazzo Barberini version) is dated c. 1599–1602. It survives.

### 题名、类型与基本信息

| 字段 | 内容 | 依据 |
|---|---|---|
| 中文规范题名 | 《朱迪斯斩杀赫罗弗尼斯》（巴贝里尼宫版本） | S1–S2 |
| 英文规范题名 | Judith Beheading Holofernes (Palazzo Barberini version) | S2 |
| 作品类型 | 绘画；具体载体与版本见下 | S2–S4（如有） |
| 创作者／归属 | 米开朗基罗·梅里西·达·卡拉瓦乔／Michelangelo Merisi da Caravaggio | S2–S4 |
| 创作年代 | 约1599–1602 | S1–S4 |
| 媒介与材质 | 布面油画（oil on canvas） | S2–S4（如有） |
| 尺寸 | 145 cm × 195 cm (57 in × 77 in) | S2 |
| 当前保管／状态 | 国立古代艺术美术馆／Galleria Nazionale d'Arte Antica；现存 | S2–S4 |
| 馆藏标识 | 2533 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 与2014年在图卢兹发现的争议对象分开。
- **版本／归属状态：** 现存。
