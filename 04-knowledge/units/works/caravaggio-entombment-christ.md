---
title: 《基督下葬》（The Entombment of Christ）
name_en: The Entombment of Christ
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将The Entombment of Christ归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://www.museivaticani.va/content/museivaticani/en/collezioni/musei/la-pinacoteca/sala-xii---secolo-xvii/caravaggio--deposizione-dalla-croce.html
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 原为新教堂小礼拜堂祭坛画；本轮当前保管使用梵蒂冈画廊对象。
- relation_type: held_by
  target: institutions/pinacoteca-vaticana.md
  note: 当前对象记录将The Entombment of Christ列由该机构保管；保管不自动等于产权。
  evidence_ref:
    doc_id: held-by-institutions-pinacoteca-vaticana-md
    source_file: https://www.museivaticani.va/content/museivaticani/en/collezioni/musei/la-pinacoteca/sala-xii---secolo-xvii/caravaggio--deposizione-dalla-croce.html
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第31项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将The Entombment of Christ列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), The Entombment of Christ (Caravaggio), revision 1361425786. https://en.wikipedia.org/wiki/The_Entombment_of_Christ_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分The Entombment of Christ的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q1213151, https://www.wikidata.org/wiki/Q1213151. Accessed 2026-09-12.
...
- citation: Collection or site authority record. https://www.museivaticani.va/content/museivaticani/en/collezioni/musei/la-pinacoteca/sala-xii---secolo-xvii/caravaggio--deposizione-dalla-croce.html. Accessed 2026-09-12.
  location: 对象字段及与身份、版本、保管、安置或委托有关的说明
  sentence_summary: 为The Entombment of Christ提供具体对象或安置记录；支持范围以正文逐项注明。
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-entombment-christ
---
...
**中文：** 《基督下葬》，年代为约1602–1604。现存。

**English:** The Entombment of Christ is dated c. 1602–1604. It survives.
...
|---|---|---|
| 中文规范题名 | 《基督下葬》 | S1–S2 |
| 英文规范题名 | The Entombment of Christ | S2 |
| 作品类型 | 绘画；具体载体与版本见下 | S2–S4（如有） |
| 创作者／归属 | 米开朗基罗·梅里西·达·卡拉瓦乔／Michelangelo Merisi da Caravaggio | S2–S4 |
| 创作年代 | 约1602–1604 | S1–S4 |
| 媒介与材质 | 布面油画（oil on canvas） | S2–S4（如有） |
| 尺寸 | 300 cm × 203 cm (120 in × 80 in) | S2 |
| 当前保管／状态 | 梵蒂冈绘画馆（Pinacoteca Vaticana）；现存 | S2–S4 |
| 馆藏标识 | MV.40386.0.0 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 原为新教堂小礼拜堂祭坛画；现由梵蒂冈绘画馆保管。
- **版本／归属状态：** 现存。
