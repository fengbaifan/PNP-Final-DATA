---
title: 库柏勒将朱庇特交给科律班忒斯哺育（Jupiter handed over by Cybele to the Corybantes to be fed）
name_en: Jupiter handed over by Cybele to the Corybantes to be fed
type: work
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 章前：图版目录；印刷页xvi；OCR L156–157
  sentence_summary: 《赞助人与画家》图版67目录所记的《库柏勒将朱庇特交给科律班忒斯哺育》艺术对象。
  original_quotes:
  - source_span: lines 156–157
    text: '67 G. M. Crespi: Jupiter handed over by Cybele to the Corybantes to

      be fed [Staatsgalerie, Stuttgart)'
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/00_05_List_of_Plates.md
    source_span: lines 156–157; 章前：图版目录；印刷页xvi
...
- relation_type: created_by
  ...
  evidence_ref:
    doc_id: zeri-119514
    source_file: https://catalogo.fondazionezeri.unibo.it/entry/work/121785/Crespi%20Giuseppe%20Maria%20%28Spagnoletto%29%2C%20Educazione%20di%20Giove
    source_span: AUTHOR、Dating；Stuttgart inv.3294
  relation_source: explicit
  review_status: evidence_backed_relation
  bidirectional_required: false
  scope: Stuttgart inv.3294
  role: 画家
  time: 1728–1729
- relation_type: commissioned_by
  target: persons/stefano-conti.md
  evidence_ref:
    doc_id: dbi-crespi
    source_file: https://www.treccani.it/enciclopedia/crespi-giuseppe-maria-detto-lo-spagnolo_(Dizionario-Biografico)/
    source_span: Giove tra i coribanti专段
  relation_source: explicit
  review_status: evidence_backed_relation
  bidirectional_required: false
  scope: Stuttgart的Giove tra i coribanti
  role: 委托人
  time: 1728–1729
- relation_type: held_by
  target: institutions/staatsgalerie-stuttgart.md
  evidence_ref:
    doc_id: zeri-119514
    source_file: https://catalogo.fondazionezeri.unibo.it/entry/work/121785/Crespi%20Giuseppe%20Maria%20%28Spagnoletto%29%2C%20Educazione%20di%20Giove
    source_span: LOCATIONS：Last known、inv.3294
  relation_source: explicit
  review_status: evidence_backed_relation
  bidirectional_required: false
  scope: 目录最后已知保管机构；不推定取得年
- relation_type: handled_by
  target: institutions/colnaghi.md
  evidence_ref:
    doc_id: zeri-119514
    source_file: https://catalogo.fondazionezeri.unibo.it/entry/work/121785/Crespi%20Giuseppe%20Maria%20%28Spagnoletto%29%2C%20Educazione%20di%20Giove
    source_span: Previous location：Colnaghi, Londra, 1976–1977
  relation_source: explicit
  review_status: evidence_backed_relation
  bidirectional_required: false
  scope: Stuttgart inv.3294的市场经手记录
  role: 经手画廊
  time: 1976–1977
---
...
**中文：** 朱塞佩·马里亚·克雷斯皮于1728–1729年为斯特凡诺·孔蒂绘制的朱庇特题材画作，斯图加特州立美术馆藏品3294。

**English:** A painting of Jupiter made by Giuseppe Maria Crespi for Stefano Conti in 1728–1729, catalogued as 3294 at the Staatsgalerie Stuttgart.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Jupiter handed over by Cybele to the Corybantes to be fed | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
| Zeri题名 | Educazione di Giove／朱庇特的养育 | S2 |
| DBI题名 | Giove tra i coribanti | S3 |
...
|---|---|---|
| 图版编号 | 67 | S1 |
| 创作者 | [朱塞佩·马里亚·克雷斯皮](../persons/giuseppe-maria-crespi.md) | S1 |
| 书中收藏／保管者 | [斯图加特州立美术馆](../institutions/staatsgalerie-stuttgart.md) | S1 |
| 书中位置 | [斯图加特](../places/stuttgart.md) | S1 |
| 图像题材 | Jupiter、Cybele、Corybantes | S1 |
...
| 创作年 | 1728–1729 | S2、S3 |
| 支撑材料 | 画布／Canvas | S2 |
| 尺寸（高×宽） | 186 × 215 cm | S2 |
| 馆藏号 | 3294 | S2 |
| 委托人 | [斯特凡诺·孔蒂](../persons/stefano-conti.md) | S3 |

### 收藏与经手记录

| 字段 | 值 | 证据 |
|---|---|---|
| 1729起：Conti收藏 | [斯特凡诺·孔蒂](../persons/stefano-conti.md)；[卢卡](../places/lucca.md) | S2、S3 |
| 1976–1977：经手画廊 | [科尔纳吉](../institutions/colnaghi.md) | S2 |
| 目录最后已知保管者 | [斯图加特州立美术馆](../institutions/staatsgalerie-stuttgart.md) | S2 |

## 关系与证据

### 身份与外部链接

[Zeri条目119514／URL work 121785](https://catalogo.fondazionezeri.unibo.it/entry/work/121785/Crespi%20Giuseppe%20Maria%20%28Spagnoletto%29%2C%20Educazione%20di%20Giove)（S2，馆藏3294）；[DBI创作与Conti段](https://www.treccani.it/enciclopedia/crespi-giuseppe-maria-detto-lo-spagnolo_(Dizionario-Biografico)/)（S3）。
