---
title: "普桑《屠杀婴孩》（本章提及）（Poussin’s Massacre of the Innocents (chapter 1 reference)）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 10.'
  ...
  sentence_summary: 与 Reni 同题作并列，但为不同画家作品。具体版本未给，合同被提为待寻线索而非现有证据。
  evidence_ref:
...
- citation: "Wikidata, Q3224378, revision 2451939180. https://www.wikidata.org/wiki/Q3224378. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "Q3224378 为 Chantilly 藏 Poussin 同题作品，题材与作者相符；章中无尺寸或版本锚点，尚未排除其他版本／复制品。"
- citation: "Wikipedia (en), The Massacre of the Innocents (Poussin), revision 1372253609. https://en.wikipedia.org/wiki/The_Massacre_of_the_Innocents_(Poussin). Accessed 2026-09-11."
  location: "全文语义阅读：正文、信息框、图注及注释／书目；不含全部外链"
  sentence_summary: "全文1052字符；Chantilly PE305候选，约1628及1625–1632年代异文；Giustiniani纪念说仅probably，1564相关叙述未采。"
- citation: "Ministère de la Culture, Joconde 00000077253, LE MASSACRE DES INNOCENTS, PE305. https://pop.culture.gouv.fr/notice/joconde/00000077253. Updated 2023-12-01; accessed 2026-09-11."
  location: "实际可读取网页1014字符全读；无尺寸及完整收藏链字段"
  sentence_summary: "Poussin，约1625或1629，Chantilly Musée Condé；相关Lille草图、Grenoble旧摹本及版画，不能把所有同题对象合并。"
...
| 题名 | 屠杀婴孩／Massacre of the Innocents | S1 |
| 所述特点 | 克制构图的杰作 | S1；Haskell评价 |
| 合同 | 作者希望找到，未报告已存合同 | S1 |
| 本章尺寸／现藏／版本 | 未给 | S1 |

### 主要候选的对象字段（不自动转为本卡确认值）
...
- S6记Giustiniani1638清册、Lucien Bonaparte、英国收藏及1854伦敦由Aumale购入；是研究目录对流传的概述，原清册和拍卖目录未读。
- S5列Lille草图、Grenoble早期摹本和版画；不能把草图或版画媒介移到原画。
- S6指出Petit-Palais另有同题且归属有争议作品，构图不同；与本章的具体对应仍需进一步论证。
- WP把Giustiniani购藏解释为纪念被奥斯曼扣押家族儿童，并写1564；该说带probably且年代可疑，本轮不采为委托动机或确定历史事件。（S4）
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| → 创作者（`created_by`） | [尼古拉·普桑（Nicolas Poussin）](../persons/nicolas-poussin.md) | 与 Reni 同题作分开；具体版本仍保留范围限制；证据：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 373–375; print pp. 10 |
