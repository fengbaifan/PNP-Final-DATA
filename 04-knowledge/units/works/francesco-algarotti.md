---
title: 弗朗切斯科·阿尔加罗蒂肖像（Portrait of Francesco Algarotti）
name_en: Portrait of Francesco Algarotti
type: work
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 《赞助人与画家》图版48d目录所记的《弗朗切斯科·阿尔加罗蒂》艺术对象。
  original_quotes:
...
**中文：** 作者佚名的弗朗切斯科·阿尔加罗蒂肖像，原书图版48d列于威尼斯科雷尔博物馆。

**English:** An anonymous portrait of Francesco Algarotti, listed in plate 48d at the Museo Correr in Venice.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Francesco Algarotti | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
