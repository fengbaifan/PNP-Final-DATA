...
**中文：** Urban VIII 为 Palatine 的 S. Sebastiano 委托，要求八个人物；画家身份由脚注收据说明，1633 材料自付信息来自相关合同。

**English:** The altarpiece commissioned by Urban VIII for S. Sebastiano on the Palatine contained eight figures, according to the receipt cited by Haskell. A 1633 agreement placed material costs on Camassei; these are specific contractual facts.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Camassei’s Martyrdom of Saint Sebastian altarpiece | S1、S2；标题中的语境说明为登记用语 |
| 委托与材料 | Urban VIII；帕拉蒂尼山 S. Sebastiano；八人物；画家承担所记材料 | S1、S2，支持范围见各条句意摘要 |
...
S1：第一章；印刷页 10；OCR L336–338,372–374；S2：第一章；印刷页 13；OCR L514–515。编号按文件头 sources 顺序对应。句意摘要是转述；具体条目支持范围以该条的章页／行号为准，不能把一个出处视为整卡全部内容的证明。
