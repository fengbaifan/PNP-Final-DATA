---
title: "巴贝里尼大厅所谓草稿（归属有争议）（Supposed bozzetto for the Barberini Salone (disputed attribution)）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 12.'
  location: 第一章；印刷页 12；OCR L463–464
  sentence_summary: 本章提及保存在宫中的所谓稿本，并认为不具说服力；无准确作者/目录号，不作为确定科尔托纳作品。
  evidence_ref:
...
**中文：** 本章提及保存在宫中的所谓稿本，并认为不具说服力；无准确作者/目录号，不作为确定科尔托纳作品。

**English:** Haskell finds the supposed sketch for the Barberini Salone unconvincing. The reference records a disputed object rather than an authenticated work by Cortona. Its precise identity and attribution require further evidence.
...
| 字段 | 当前结论 | 依据／边界 |
|---|---|---|
| 作品名／规范指称 | 巴贝里尼大厅所谓草稿（Supposed bozzetto for the Barberini Salone） | 精确题名可证时采用；不可证时保留描述性名 |
| 创作者／归属 | 旧归属指向Pietro da Cortona，但本章明确认为证据不具说服力 | 争议归属不写成确定事实 |
| 创作／委托时间 | 未核定 | 区分合同、开工、完成、毁失或后续记录 |
| 委托人／赞助方 | Barberini语境；具体委托链未由本卡证实 | 仅写当前证据可支持的法律或历史主体 |
