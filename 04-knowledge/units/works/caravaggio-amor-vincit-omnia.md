---
title: 《爱神战胜一切》（Amor Vincit Omnia）
name_en: Amor Vincit Omnia
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将Amor Vincit Omnia归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
    doc_id: created-by-persons-caravaggio-md
    source_file: https://id.smb.museum/object/862322
    source_span: 本卡S2；有S4时并参对象字段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 创作者
  scope: 为文琴佐·朱斯蒂尼亚尼而作，现藏柏林；与巴廖内同题回应作品分开。
- relation_type: held_by
  target: institutions/gemaeldegalerie-berlin.md
  note: 当前对象记录将Amor Vincit Omnia列由该机构保管；保管不自动等于产权。
  evidence_ref:
...
- relation_type: commissioned_by
  ...
  note: 来源明确该端点承担Amor Vincit Omnia的委托角色；不由委托推定当前所有权。
  evidence_ref:
...
- relation_type: owned_by
  target: persons/marchese-giustiniani-ch1.md
  note: 来源支持该端点在所列时期收藏或拥有Amor Vincit Omnia；不等于当前保管。
  evidence_ref:
    doc_id: owned-by-persons-marchese-giustiniani-ch1-md
    source_file: https://id.smb.museum/object/862322
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第35项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将Amor Vincit Omnia列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), Amor Vincit Omnia (Caravaggio), revision 1361242553. https://en.wikipedia.org/wiki/Amor_Vincit_Omnia_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分Amor Vincit Omnia的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q474024, https://www.wikidata.org/wiki/Q474024. Accessed 2026-09-12.
...
- citation: Collection or site authority record. https://id.smb.museum/object/862322. Accessed 2026-09-12.
  location: 对象字段及与身份、版本、保管、安置或委托有关的说明
  sentence_summary: 为Amor Vincit Omnia提供具体对象或安置记录；支持范围以正文逐项注明。
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-amor-vincit-omnia
---
...
**中文：** 《爱神战胜一切》，年代为1601–1602。现存。

**English:** Amor Vincit Omnia is dated 1601–1602. It survives.
...
|---|---|---|
| 中文规范题名 | 《爱神战胜一切》 | S1–S2 |
| 英文规范题名 | Amor Vincit Omnia | S2 |
| 作品类型 | 绘画；具体载体与版本见下 | S2–S4（如有） |
| 创作者／归属 | 米开朗基罗·梅里西·达·卡拉瓦乔／Michelangelo Merisi da Caravaggio | S2–S4 |
| 创作年代 | 1601–1602 | S1–S4 |
| 媒介与材质 | 布面油画（oil on canvas） | S2–S4（如有） |
| 尺寸 | 未载 | S2 |
| 当前保管／状态 | 柏林绘画馆／Gemäldegalerie Berlin；现存 | S2–S4 |
| 馆藏标识 | 369 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 为文琴佐·朱斯蒂尼亚尼而作，现藏柏林；与巴廖内同题回应作品分开。
- **版本／归属状态：** 现存。
