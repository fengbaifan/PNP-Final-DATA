---
title: 雷佐尼科家族婚姻寓意（Marriage Allegory of the Rezzonico family）
name_en: Marriage Allegory of the Rezzonico family
type: work
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 《赞助人与画家》图版43目录所记的《雷佐尼科家族婚姻寓意》艺术对象。
  original_quotes:
...
- relation_type: created_by
  ...
  evidence_ref:
    doc_id: works-tiepolo-marriage-allegory-of-the-rezzonico-family
    source_file: https://carezzonico.visitmuve.it/en/layout-and-collections/first-floor/
    source_span: Nuptial Allegory Room
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 主画作者
  scope: 婚姻寓意厅顶画；保存馆方逐人分工，不将三人都称整幅独立作者
  time: 1757年冬
- relation_type: created_by
  target: persons/girolamo-mengozzi-colonna.md
  evidence_ref:
    doc_id: works-tiepolo-marriage-allegory-of-the-rezzonico-family
    source_file: https://carezzonico.visitmuve.it/en/layout-and-collections/first-floor/
    source_span: Nuptial Allegory Room
  ...
  time: 1757年冬
- relation_type: created_by
  target: persons/giandomenico-tiepolo.md
  evidence_ref:
    doc_id: works-tiepolo-marriage-allegory-of-the-rezzonico-family
    source_file: https://carezzonico.visitmuve.it/en/layout-and-collections/first-floor/
    source_span: Nuptial Allegory Room
...
- relation_type: has_subject
  target: families/rezzonico-family.md
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/00_05_List_of_Plates.md
    source_span: lines 116–117; 章前：图版目录；印刷页xiv
  ...
  bidirectional_required: false
  role: 颂扬家族
  scope: 原书婚姻寓意题名；不据家族题名推定具体新人身份或婚姻双方
- relation_type: installed_at
  ...
  bidirectional_required: false
  role: 婚姻寓意厅天顶
  scope: 馆方Nuptial Allegory Room所述装饰
  time: 1757年冬绘成
...
**中文：** 1757年冬绘于威尼斯雷佐尼科宫的婚姻寓意顶画，由乔万巴蒂斯塔·提埃坡罗主绘，门戈齐·科隆纳绘建筑幻景，乔万多梅尼科·提埃坡罗绘萨堤尔。

**English:** A nuptial allegory ceiling painted at Ca’ Rezzonico in Venice in winter 1757, principally by Giambattista Tiepolo, with fictive architecture by Mengozzi Colonna and satyrs by Giandomenico Tiepolo.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Marriage Allegory of the Rezzonico family | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
