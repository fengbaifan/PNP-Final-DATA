---
title: 《施洗者圣约翰斩首》（The Beheading of Saint John the Baptist）
name_en: The Beheading of Saint John the Baptist
type: work
created: '2026-09-13'
updated: 2026-09-14
...
- relation_type: created_by
  ...
  note: 具体对象页将The Beheading of Saint John the Baptist归于卡拉瓦乔；本边保留版本边界。
  evidence_ref:
  ...
  role: 创作者
  scope: 卡拉瓦乔最大尺幅且有签名的作品；与两幅莎乐美及其他施洗者题材分开。
- relation_type: installed_at
  target: places/st-johns-co-cathedral.md
  note: 来源将The Beheading of Saint John the Baptist与该实际或历史安置地点对应。
  evidence_ref:
...
- relation_type: intended_for
  target: places/st-johns-co-cathedral.md
  note: The Beheading of Saint John the Baptist原定用于该建筑或礼拜堂。
  evidence_ref:
    doc_id: intended-for-places-st-johns-co-cathedral-md
    source_file: https://www.stjohnscocathedral.com/the-co-cathedral/caravaggio/
...
- citation: Wikipedia (en), Caravaggio, revision 1372526492. https://en.wikipedia.org/wiki/Caravaggio. Accessed 2026-09-11.
  location: 人物页具名对象清单第39项及相邻语境；全文REV-052已保存
  sentence_summary: 主页面将The Beheading of Saint John the Baptist列入具名作品、版本或归属讨论；不由此证明全部字段。
- citation: Wikipedia (en), The Beheading of Saint John the Baptist (Caravaggio), revision 1371888070. https://en.wikipedia.org/wiki/The_Beheading_of_Saint_John_the_Baptist_(Caravaggio). Accessed 2026-09-12.
  location: 全文语义阅读；正文、信息框、图注及注释／书目文本；外链页面另计
  sentence_summary: 区分The Beheading of Saint John the Baptist的对象、版本、年代、材料、流传、归属与当前状态。
- citation: Wikidata, Q2727560, https://www.wikidata.org/wiki/Q2727560. Accessed 2026-09-12.
...
- citation: Collection or site authority record. https://www.stjohnscocathedral.com/the-co-cathedral/caravaggio/. Accessed 2026-09-12.
  ...
  sentence_summary: 为The Beheading of Saint John the Baptist提供具体对象或安置记录；支持范围以正文逐项注明。
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-works-caravaggio-beheading-john-baptist
---
...
**中文：** 《施洗者圣约翰斩首》，年代为1608。现存。

**English:** The Beheading of Saint John the Baptist is dated 1608. It survives.

### 题名、类型与基本信息

| 字段 | 内容 | 依据 |
|---|---|---|
| 中文规范题名 | 《施洗者圣约翰斩首》 | S1–S2 |
| 英文规范题名 | The Beheading of Saint John the Baptist | S2 |
...
| 尺寸 | 370 cm × 520 cm (150 in × 200 in) | S2 |
| 当前保管／状态 | 现存；现存 | S2–S4 |
| 馆藏标识 | 未取得可安全采用的单一馆藏号 | S3–S4 |

### 委托、版本、存世与流传

- **对象边界：** 卡拉瓦乔最大尺幅且有签名的作品；与两幅莎乐美及其他施洗者题材分开。
- **版本／归属状态：** 现存。
