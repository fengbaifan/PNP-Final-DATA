---
title: 弗朗切斯科·阿尔加罗蒂墓（Tomb of Francesco Algarotti）
name_en: Tomb of Francesco Algarotti
type: work
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版60目录将其记为描绘地点／对象。
  original_quotes:
...
- relation_type: created_by
  target: persons/mauro-antonio-tesi.md
  evidence_ref:
    doc_id: works-tomb-of-francesco-algarotti
    source_file: https://www.metmuseum.org/art/collection/search/335623
    source_span: 作品说明：Tesi设计
...
- relation_type: commissioned_by
  ...
  evidence_ref:
    doc_id: works-tomb-of-francesco-algarotti
    source_file: https://id.rijksmuseum.nl/200471954
    source_span: 2015-08-27馆方说明
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 墓设计委托人
...
**中文：** 比萨坎波桑托内纪念弗朗切斯科·阿尔加罗蒂的墓，由泰西设计，比安科尼负责建造。

**English:** A tomb commemorating Francesco Algarotti in the Camposanto, Pisa, designed by Tesi and constructed under Bianconi’s responsibility.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Tomb of Francesco Algarotti | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版60角色 | 描绘地点／对象 | S1 |
| 图版60相关对象 | [阿尔加罗蒂墓前悼念者](../works/g-volpato-mourners-at-tomb-of-francesco-algarotti-in-pisa.md)；描绘地点／对象 | S1 |

### 设计、委托与安置

| 字段 | 值 | 证据 |
|---|---|---|
| 设计者 | [毛罗·安东尼奥·泰西](../persons/mauro-antonio-tesi.md) | S2、S3 |
| 负责建造的建筑师 | [卡洛·比安科尼](../persons/carlo-bianconi.md) | S2、S3 |
| 设计委托人 | [弗朗切斯科·阿尔加罗蒂](../persons/francesco-algarotti.md) | S3 |
| 纪念对象 | [弗朗切斯科·阿尔加罗蒂](../persons/francesco-algarotti.md) | S1、S2、S3 |
| 安置地点 | [比萨坎波桑托](../places/camposanto-pisa.md) | S2、S3 |

## 关系与证据

### 身份与外部链接

[Met墓建造说明](https://www.metmuseum.org/art/collection/search/335623)（S2）；[Rijksmuseum墓委托与安置说明](https://id.rijksmuseum.nl/200471954)（S3）。
