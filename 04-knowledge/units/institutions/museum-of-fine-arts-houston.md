---
title: 休斯敦美术馆（The Museum of Fine Arts, Houston）
name_en: The Museum of Fine Arts, Houston
type: institution
...
- citation: The Museum of Fine Arts, Houston, History. https://www.mfah.org/about/history. Accessed 2026-09-15.
  location: 完整From Aspiration to Major Art Museum正文及页脚；未展开各场馆链接
  sentence_summary: 1900年志愿艺术教育活动为前史；美术馆于1924年开放，现为综合艺术收藏机构，位于Houston,Texas。
created: '2026-09-14'
updated: '2026-09-15'
process_ref: 03-processing/patrons-and-painters-front-matter/process/knowledge.md#大学博物馆与馆藏关系集中补足
relations:
- relation_type: located_at
  target: places/houston.md
  evidence_ref:
    doc_id: institutions-museum-of-fine-arts-houston
    source_file: https://www.mfah.org/about/history
    source_span: From Aspiration to Major Art Museum及页脚Houston,TX
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 所在城市
  scope: 机构所在地；不以1900年前期活动冒充开馆年
...
**中文：** 收藏索利梅纳《狄多与埃涅阿斯的皇家狩猎》的美术馆。

**English:** The museum holding Solimena’s The Royal Hunt of Dido and Aeneas.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 英文名 | The Museum of Fine Arts, Houston | S1 |
| 简称 | MFAH | S1 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 收藏作品 | [狄多与埃涅阿斯的皇家狩猎](../works/solimena-dido-and-aeneas.md) | S1 |
| 入藏年 | 2000 | S1 |
| 藏品号 | 2000.92 | S1 |
...
| 前期艺术教育活动 | 1900 | S2 |
| 开馆年 | 1924 | S2 |
| 所在地 | [休斯敦](../places/houston.md) | S2 |
| 收藏性质 | 综合艺术收藏／Encyclopedic art collection | S2 |
...
[官方馆史](https://www.mfah.org/about/history)（S2）。

[馆藏2000.92](https://emuseum.mfah.org/objects/48122/visit)（S1）
