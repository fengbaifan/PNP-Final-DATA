---
title: 卡比托利欧绘画馆（Pinacoteca Capitolina）
name_en: Pinacoteca Capitolina
type: institution
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版10a目录将其记为书中收藏／保管者。
  original_quotes:
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版11a目录将其记为书中收藏／保管者。
  original_quotes:
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版11b目录将其记为书中收藏／保管者。
  original_quotes:
...
- citation: Musei Capitolini, Pinacoteca Capitolina. https://www.museicapitolini.org/it/percorsi/pinacoteca-capitolina.
    Accessed 2026-09-15.
  location: 完整馆藏部门介绍正文及所在楼层说明；不含链接的各展室详情
  sentence_summary: 绘画馆于1748–1750年形成，绘画藏品陈列于Palazzo dei Conservatori二楼。
created: '2026-09-14'
updated: '2026-09-15'
...
- relation_type: part_of
  ...
  evidence_ref:
    doc_id: institutions-pinacoteca-capitolina
    source_file: https://www.museicapitolini.org/it/percorsi/pinacoteca-capitolina
    source_span: 完整馆藏部门介绍正文及所在楼层说明；不含链接的各展室详情
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  scope: 馆方现行收藏部门；不同于建筑空间
  role: 绘画收藏部门
- relation_type: located_at
  target: places/palazzo-dei-conservatori.md
  evidence_ref:
    doc_id: institutions-pinacoteca-capitolina
    source_file: https://www.museicapitolini.org/it/percorsi/pinacoteca-capitolina
    source_span: 完整馆藏部门介绍正文及所在楼层说明；不含链接的各展室详情
...
**中文：** 卡比托利欧绘画馆是罗马卡比托利欧博物馆的绘画收藏部门，藏品陈列于保守宫二楼。

**English:** The Pinacoteca Capitolina is the painting collection of the Capitoline Museums in Rome, displayed on the second floor of the Palazzo dei Conservatori.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Pinacoteca Capitolina | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版10a角色 | 书中收藏／保管者 | S1 |
| 图版10a相关对象 | [劫夺萨宾妇女](../works/pietro-da-cortona-rape-of-the-sabines.md)；书中收藏／保管者 | S1 |
| 图版11a角色 | 书中收藏／保管者 | S2 |
| 图版11a相关对象 | [以扫与雅各相会](../works/gio-maria-bottalla-meeting-of-esau-and-jacob.md)；书中收藏／保管者 | S2 |
| 图版11b角色 | 书中收藏／保管者 | S3 |
| 图版11b相关对象 | [约瑟被兄弟出卖](../works/pietro-testa-joseph-sold-by-his-brothers.md)；书中收藏／保管者 | S3 |

### 机构信息

| 字段 | 值 | 证据 |
|---|---|---|
| 所属博物馆 | [卡比托利欧博物馆](capitoline-museums.md) | S4 |
| 所在建筑 | [保守宫](../places/palazzo-dei-conservatori.md) | S4 |
| 楼层 | 二楼／second floor | S4 |
| 形成时段 | 1748–1750 | S4 |
...
[馆方绘画馆介绍](https://www.museicapitolini.org/it/percorsi/pinacoteca-capitolina)（S4）
