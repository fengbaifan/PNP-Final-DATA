...
| ← 取得者（`acquirer_of`，反向投影） | [凝视荷马像的亚里士多德（Aristotle contemplating the bust of Homer）](../works/rembrandt-aristotle-contemplating-the-bust-of-homer.md) | 时间：1961；角色：购入机构；范围：图版35a所列购入记录；原断言与证据见发出端卡片“凝视荷马像的亚里士多德（Aristotle contemplating the bust of Homer）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；patrons-and-painters；lines 97–99; 章前：图版目录；印刷页xiv |
| ← 保管对象（`holder_of`，反向投影） | [胡安·德·帕雷哈肖像（Portrait of Juan de Pareja）](../works/velasquez-juan-de-pareja.md) | 角色：所引馆藏记录保管机构；范围：1971.86；原断言与证据见发出端卡片“胡安·德·帕雷哈肖像（Portrait of Juan de Pareja）”：[来源](https://www.metmuseum.org/art/collection/search/437869)；works-velasquez-juan-de-pareja；Artwork Details及馆藏号 |
| ← 取得者（`acquirer_of`，反向投影） | [胡安·德·帕雷哈肖像（Portrait of Juan de Pareja）](../works/velasquez-juan-de-pareja.md) | 时间：1971；角色：购入机构；范围：1971.86；原断言与证据见发出端卡片“胡安·德·帕雷哈肖像（Portrait of Juan de Pareja）”：[来源](https://www.metmuseum.org/art/collection/search/437869)；works-velasquez-juan-de-pareja；Artwork Details：Credit line |
