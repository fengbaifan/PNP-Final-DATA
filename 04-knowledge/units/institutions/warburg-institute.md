---
title: 瓦尔堡研究院（Warburg Institute）
name_en: Warburg Institute
type: institution
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  ...
  sentence_summary: 作者致谢的伦敦研究组织，其图书馆提供研究支持。
  original_quotes:
...
- relation_type: part_of
  target: institutions/university-of-london.md
  evidence_ref:
    doc_id: institutions-warburg-institute
    source_file: https://warburg.sas.ac.uk/about-us/history-warburg-institute
    source_span: 首段及The Move to London的1944段
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  scope: 1944年起成为伦敦大学组成机构；图书馆另设KU
  role: 大学所属研究所
  time: 1944起
- relation_type: located_at
  ...
  evidence_ref:
    doc_id: institutions-warburg-institute
    source_file: https://warburg.sas.ac.uk/about-us/history-warburg-institute
    source_span: 首段及The Move to London
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  scope: 1933年迁入伦敦；不由此确定各阶段街道地址
  role: 迁入城市
  time: 1933起
---
...
**中文：** 位于伦敦的艺术与文化研究机构，1944年成为伦敦大学的一部分，其图书馆曾支持哈斯克尔的研究。

**English:** An institute for the study of art and culture in London, part of the University of London since 1944, whose library supported Haskell’s research.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Warburg Institute | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 章前记载 | 作者致谢的伦敦研究组织，其图书馆提供研究支持。 | S1 |

### 机构信息

| 字段 | 值 | 证据 |
|---|---|---|
| 性质 | 研究机构／Research institute | S2 |
| 所在地 | [伦敦](../places/london.md) | S1、S2 |
| 所属大学 | [伦敦大学](university-of-london.md) | S2 |
| 所属起年 | 1944 | S2 |
| 图书馆 | [瓦尔堡研究所图书馆](warburg-institute-library.md) | S1、S2 |
...
|---|---|---|
| 1921 | 由图书馆发展为研究所 | S2 |
| 1933 | 迁往[伦敦](../places/london.md) | S2 |
| 1958 | 迁入Bloomsbury永久馆舍 | S2 |

## 关系与证据

### 身份与外部链接

[研究所官方历史](https://warburg.sas.ac.uk/about-us/history-warburg-institute)（S2）。

### 关系记录

| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| ← 包含成员（`contains`，反向投影） | [瓦尔堡研究院图书馆（Library of the Warburg Institute）](warburg-institute-library.md) | 角色：所属图书馆；范围：第一版序言Library of the Warburg Institute；机构图书馆的归属；原断言与证据见发出端卡片“瓦尔堡研究院图书馆（Library of the Warburg Institute）”：[来源](../../../02-sources/02-Markdown/00_03_Preface_1st_Ed.md)；haskell-1980-rev-ed；lines 21–22; 章前：第一版序言；印刷页ix；PDF 7 |
| → 组成部分（`part_of`） | [伦敦大学（University of London）](university-of-london.md) | 时间：1944起；角色：大学所属研究所；范围：1944年起成为伦敦大学组成机构；图书馆另设KU；证据：[来源](https://warburg.sas.ac.uk/about-us/history-warburg-institute)；src-5488d2d1a67dd21f；首段及The Move to London的1944段 |
| → 位于（`located_at`） | [伦敦（London）](../places/london.md) | 时间：1933起；角色：迁入城市；范围：1933年迁入伦敦；不由此确定各阶段街道地址；证据：[来源](https://warburg.sas.ac.uk/about-us/history-warburg-institute)；src-5488d2d1a67dd21f；首段及The Move to London |
