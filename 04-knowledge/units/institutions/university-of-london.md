---
title: 伦敦大学（University of London）
name_en: University of London
type: institution
...
**中文：** 伦敦的大学，1944年接纳瓦尔堡研究所，并为其建设永久馆舍。

**English:** A university in London that received the Warburg Institute in 1944 and provided its permanent premises.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 英文名 | University of London | S1 |
| 中文名性质 | 项目采用译名 | 项目命名 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 机构 | [瓦尔堡研究所](warburg-institute.md) | S1 |
| 纳入年份 | 1944 | S1 |
