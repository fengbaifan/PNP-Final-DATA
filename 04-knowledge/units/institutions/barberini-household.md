---
title: "巴贝里尼家族及家户（Barberini Family and Households）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 3.'
  location: 第一章；印刷页 3；OCR L15–47
  sentence_summary: Barberini 时期被描述为赞助繁荣，同时保留教皇、家长与统治者角色的张力。
  evidence_ref:
...
- citation: "Wikidata, Q807815, revision 2491112480. https://www.wikidata.org/wiki/Q807815. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "候选 Q807815 指整个 Barberini 家族，本卡同时记多个家户。暂不将家族 QID 当各家户统一标识；在补足中先明确本卡对象范围。"
- citation: "Wikipedia (en), Barberini family, revision 1373803652. https://en.wikipedia.org/wiki/Barberini_family. Accessed 2026-09-11."
  location: "家族候选页全文13123字符，含历史、赞助、家谱、注释书目"
  sentence_summary: "用于辨识Maffeo／Urban VIII、侄辈Francesco、Antonio、Taddeo与年长Antonio；家谱、头衔和现代传承不等于各家户的组织结构。家族候选仍不覆盖混合记录。"
- citation: "Wikidata, Q807815, revision 2491112480. https://www.wikidata.org/wiki/Q807815. Accessed 2026-09-11."
  location: "enwiki sitelink与家族对象范围；不批量导入家族字段"
  sentence_summary: "与Barberini family页对应；不为Antonio、Francesco或Taddeo各自家户提供统一身份QID。"
...
**中文：** 本卡暂存本章将巴贝里尼家族集体赞助与个别成员家户合称的记录。外部研究明确了Francesco、Antonio和Taddeo在住所、支出和艺术家服务关系上的区别；本卡按主体分字段保存，不把家族、家户、宫殿和教皇政府合成一个机构。（S1–S3、S6–S8）

**English:** This entry preserves the chapter’s mixed references to collective Barberini patronage and individual family members’ households. External scholarship distinguishes Francesco, Antonio and Taddeo by residence, expenditure and artists’ service relationships. The record separates these actors rather than treating the family, households, palace and papal government as one institution. (S1–S3, S6–S8)

### 对象与名称

| 字段 | 内容 | 依据 |
|---|---|---|
| 当前名称／Working name | Barberini Family and Households；来源混合范围的描述，不是正式机构名称 | S1–S3 |
| 记录性质／Record status | 尚待分清的混合卡，暂留institution；不因此认定全部家族属于机构 | 既有REV-036裁决 |
| 家族部分／Dynastic component | 家族血缘、婚姻与集体声望；不能吸收雇员为亲属 | S6 |
| 家户部分／Household component | 分属具体保护人的侍从、薪酬与服务组织；有艺人和其他工作人员 | S2、S8 |
| 主要地点／Locations | 罗马；Quattro Fontane、Cancelleria、Via de’ Giubbonari等住所随人物与时期分别定位 | S8 |
| 成立日／Founder | 当前混合卡无统一成立日或创始人；不导入家族候选信息框的1530–1559或早期祖先作为家户成立日期 | S6与本卡范围 |

### 主体与责任分开

| 主体 | 身份及本卡适用事项 | 依据 |
|---|---|---|
| Maffeo／Urban VIII | 教皇及家族成员；教皇职权与家族赞助责任分开 | S1、S6 |
| Francesco Barberini（1597–1679） | 侄辈枢机；Frescobaldi是其受薪家户成员；1632年后驻Cancelleria；经营音乐、戏剧等文化活动 | S8 |
| Antonio Barberini（1607–1671） | 另一侄辈枢机；Sacchi的1640年家户晋级属于本人家户；1642年歌剧Il palazzo incantato与Sacchi舞台设计为外部研究所述活动 | S2、S8 |
| Taddeo Barberini（1603–1647） | 世俗亲王；与Anna Colonna居住安排及Frescobaldi教授其子女分开记录 | S8 |
| 年长Antonio | 嘉布遣会枢机、上述侄辈的叔辈；称Cardinal Sant’Onofrio，不能和Sacchi的保护人混同 | S8 |

### 活动、住所与人员关系

- **薪酬与人员：** Francesco家户有受薪音乐家及私人音乐活动组织。S8的相关人数与薪酬仅是特定账目口径，不据此给全家族合并统计。
- **不同关系并存：** Frescobaldi受薪于Francesco、向Antonio献作，并为Taddeo的子女授课。献辞、教学、受雇分别证明，不能从同一家族活动推定多重正式雇用。（S8）
- **住所变更：** 新宫原为Taddeo与Francesco安排；Taddeo一家1632年入住、1634年回旧宫，Francesco1632年转Cancelleria，Antonio成为Quattro Fontane宫殿使用者。住所使用、租赁、所有权并非同义，未读产权文书不补完整产权链。（S8）
- **家户晋级：** 本章Sacchi事例保留在[1640年事件卡](../events/sacchi-household-promotion-1640.md)，不迁到Francesco名下。（S2）
