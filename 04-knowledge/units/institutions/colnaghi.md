...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 12.'
  ...
  sentence_summary: 本章通过科尔纳吉画廊 1961 年 5–6 月图录第 2 号定位 Sacchi 的罗马 Capuchin 教堂祭坛稿。这里登记画商／画廊机构，与图录和作品分开；目录信息不单独证明已经售出。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 467–468; print pp. 12
...
| 字段 | 值 | 证据 |
|---|---|---|
| 1976–1977 | [克雷斯皮的朱庇特画作](../works/g-m-crespi-jupiter-handed-over-by-cybele-to-the-corybantes-to-be-fed.md)，现编斯图加特3294 | S7 |
...
[Zeri 119514流传记录](https://catalogo.fondazionezeri.unibo.it/entry/work/121785/Crespi%20Giuseppe%20Maria%20%28Spagnoletto%29%2C%20Educazione%20di%20Giove)（S7，Colnaghi经手时期）。

- [Wikipedia（英文）](https://en.wikipedia.org/wiki/P._%26_D._Colnaghi_%26_Co.)
- [Wikidata Q5147759](https://www.wikidata.org/wiki/Q5147759)

[既有处理依据](../../../03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-institutions-colnaghi)
