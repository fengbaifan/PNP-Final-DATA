---
title: 剑桥国王学院（King's College, Cambridge）
name_en: King's College, Cambridge
type: institution
...
**中文：** 剑桥大学的学院，哈斯克尔于1948年入学，并在本书第一版序言中感谢学院对写作的支持。

**English:** A college of the University of Cambridge which Haskell entered in 1948 and thanked for support in the first-edition preface.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | King's College, Cambridge | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 章前记载 | 作者感谢本学院院长及院士支持写书，并以学院署名。 | S1 |

### 本书作者的教育经历

| 字段 | 值 | 证据 |
|---|---|---|
| 1948年入学者 | [弗朗西斯·哈斯克尔](../persons/francis-haskell.md) | S2，p.228 |

## 关系与证据

### 身份与外部链接

[British Academy Haskell传记p.228](https://www.thebritishacademy.ac.uk/documents/366/115p227.pdf)（S2，1948年入学）。
