---
title: 弗拉里教堂（Church of the Frari）
name_en: Church of the Frari
type: place
...
**English:** The entry for plate 41b records this entity in the role of location.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Church of the Frari | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版41b角色 | 书中位置 | S1 |
| 图版41b相关对象 | [乔瓦尼·佩萨罗总督纪念碑](../works/monument-to-doge-giovanni-pesaro.md)；书中位置 | S1 |
