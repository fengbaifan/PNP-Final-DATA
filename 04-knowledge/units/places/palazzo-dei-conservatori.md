---
title: 保守宫（Palazzo dei Conservatori）
name_en: Palazzo dei Conservatori
type: place
...
**English:** The entry for plate 02b records this entity in the role of location.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Palazzo dei Conservatori | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版02b角色 | 书中位置 | S1 |
| 图版02b相关对象 | [乌尔班八世肖像](../works/bernini-maffeo-barberini-as-pope-urban-viii.md)；书中位置 | S1 |
