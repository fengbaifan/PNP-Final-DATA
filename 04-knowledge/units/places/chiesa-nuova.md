...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 11.'
  ...
  sentence_summary: Rubens 1606 年接受祭坛画前被要求展示绘画样例的教堂。
  evidence_ref:
...
- citation: "Wikidata, Q2031901, revision 2507301391. https://www.wikidata.org/wiki/Q2031901. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "罗马 Santa Maria in Vallicella 又称 Chiesa Nuova；建筑与 Oratorians 分开。"
- citation: "Wikipedia (en), Santa Maria in Vallicella, revision 1362822909. https://en.wikipedia.org/wiki/Santa_Maria_in_Vallicella Accessed 2026-09-11."
  location: "全文8813字符；章节：History、Interior、Chapels、Cardinal-Priests、See also、References、Bibliography、External links"
...
**中文：** Rubens 1606 年接受祭坛画前被要求展示绘画样例的教堂。

**English:** Rubens was required to show an example of his painting before receiving its altarpiece commission in 1606.
