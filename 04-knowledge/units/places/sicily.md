...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 9.'
  location: 第一章；印刷页 9；OCR L295–307,322
  sentence_summary: Guercino 1665 委托来自 Sicily，另有 Augusta 的 Minnitti 1617 合同。
  evidence_ref:
...
- citation: "Wikidata, Q1460, revision 2535583020. https://www.wikidata.org/wiki/Q1460. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "英文页面兼述岛与现代自治区，Q1460 以地区行政类型为主；本章地理岛屿范围须与自治区区分后再选 QID。"
- citation: "Wikipedia (en), Sicily, revision 1372963625. https://en.wikipedia.org/wiki/Sicily Accessed 2026-09-11."
  location: "全文77674字符；章节：Etymology、History、Prehistory、Antiquity、Roman and Germanic viceregal rule (469–535)、Byzantine period (535–827)、Arab period (827–1091)、Norman Sicily (1038–1198)、Kingdom of Sicily (1198–1860)、Italian unification、20th and 21st centuries、Geography"
...
**中文：** Guercino 1665 年修道院祭坛画委托目的地、Augusta 地理限定及 Valguarnera 来源身份的地域。

**English:** Sicily is the destination of Guercino's monastery altarpiece commission of 1665, the geographical qualifier for Augusta, and the region associated with Valguarnera's origin.
