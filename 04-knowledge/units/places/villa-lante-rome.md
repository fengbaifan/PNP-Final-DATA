---
title: 罗马兰特别墅（Villa Lante, Rome）
name_en: Villa Lante, Rome
type: place
...
**中文：** 位于罗马贾尼科洛山的文艺复兴别墅，是罗马芬兰研究所的所在地。

**English:** A Renaissance villa on the Gianicolo in Rome that houses the Finnish Institute in Rome.
...
|---|---|---|
| 类别 | 别墅／Villa | S1 |
| 建筑时期 | 文艺复兴时期／Renaissance | S1 |
| 所在地 | [罗马](rome.md)，Gianicolo | S1 |
| 地址 | Passeggiata del Gianicolo 10 | S1 |
| 使用机构 | [罗马芬兰研究所](../institutions/finnish-institute.md) | S1 |

## 关系与证据

### 身份与外部链接

[罗马市关于研究所和建筑的介绍](https://www.turismoroma.it/it/luoghi/istituto-finlandese-di-roma)（S1）。
