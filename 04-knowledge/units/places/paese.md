...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版64目录将其记为描绘地点／对象。
  original_quotes:
...
**中文：** 图版64目录将其记为描绘地点／对象。

**English:** The entry for plate 64 records this entity in the role of depicted place or object.
...
|---|---|---|
| 图版64角色 | 描绘地点／对象 | S1 |
| 图版64相关对象 | [约翰·斯特兰奇别墅景观](../works/francesco-guardi-view-of-john-strange-s-villa-at-paese-near-treviso.md)；描绘地点／对象 | S1 |
