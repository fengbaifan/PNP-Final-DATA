...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版17a目录将其记为书中位置。
  original_quotes:
...
**English:** The entry for plate 17a records this entity in the role of location.
...
|---|---|---|
| 图版17a角色 | 书中位置 | S1 |
| 图版17a相关对象 | [卡西亚诺·达尔·波佐漫画](../works/bernini-caricature-of-cassiano-dal-pozzo.md)；书中位置 | S1 |
