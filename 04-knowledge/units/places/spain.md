...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 18.'
  ...
  sentence_summary: Procaccini 的传记描述所涉目的地；本章未给此行年月。
  evidence_ref:
...
- citation: "Wikipedia (en), Spain, revision 1373326506. https://en.wikipedia.org/wiki/Spain. Accessed 2026-09-10."
...
process_ref: 03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-places-spain
---
...
**中文：** Procaccini 的传记描述所涉目的地；本章未给此行年月。

**English:** Spain is a destination mentioned in Procaccini's biography as cited by Haskell. The chapter supplies no date for the journey.
...
- [Q29](https://www.wikidata.org/wiki/Q29)
