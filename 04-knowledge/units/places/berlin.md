...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版53b目录将其记为书中位置。
  original_quotes:
...
**English:** The entry for plate 53b records this entity in the role of location.
...
|---|---|---|
| 图版53b角色 | 书中位置 | S1 |
| 图版53b相关对象 | [西吉斯蒙德·施特赖特肖像](../works/amigoni-sigismund-streit.md)；书中位置 | S1 |
