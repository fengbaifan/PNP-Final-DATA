...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版18a目录将其记为描绘地点／对象。
  original_quotes:
...
**中文：** 图版18a目录将其记为描绘地点／对象。

**English:** The entry for plate 18a records this entity in the role of depicted place or object.
...
|---|---|---|
| 图版18a角色 | 描绘地点／对象 | S1 |
| 图版18a相关对象 | [逃往埃及途中的休息](../works/pietro-testa-rest-on-the-flight-into-egypt.md)；描绘地点／对象 | S1 |
