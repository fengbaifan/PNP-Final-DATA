...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版52b目录将其记为书中位置。
  original_quotes:
...
**English:** The entry for plate 52b records this entity in the role of location.
...
|---|---|---|
| 图版52b角色 | 书中位置 | S1 |
| 图版52b相关对象 | [蒂洛特森大主教寓意纪念墓](../works/canaletto-allegorical-tomb-to-the-memory-of-archbishop-tillotson.md)；书中位置 | S1 |
