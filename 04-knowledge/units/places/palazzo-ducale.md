---
title: 总督宫（威尼斯）（Palazzo Ducale）
name_en: Palazzo Ducale
type: place
...
**English:** The entry for plate 42a records this entity in the role of location.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Palazzo Ducale | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版42a角色 | 书中位置 | S1 |
| 图版42a相关对象 | [海神向威尼斯致敬](../works/tiepolo-neptune-paying-homage-to-venice.md)；书中位置 | S1 |
