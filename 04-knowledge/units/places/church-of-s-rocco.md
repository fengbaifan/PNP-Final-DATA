---
title: 圣洛克堂（威尼斯）（Church of S. Rocco）
name_en: Church of S. Rocco
type: place
...
**中文：** 图版56目录将其记为描绘地点／对象。

**English:** The entry for plate 56 records this entity in the role of depicted place or object.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Church of S. Rocco | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版56角色 | 描绘地点／对象 | S1 |
| 图版56相关对象 | [圣洛克堂画展](../works/marieschi-picture-exhibition-at-church-of-s-rocco.md)；描绘地点／对象 | S1 |
