---
title: 阿尼克城堡（Alnwick Castle）
name_en: Alnwick Castle
type: place
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 图版03b目录将其记为书中位置。
  original_quotes:
...
**English:** The entry for plate 03b records this entity in the role of location.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 原文名称 | Alnwick Castle | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版03b角色 | 书中位置 | S1 |
| 图版03b相关对象 | [安东尼奥·巴贝里尼枢机](../works/carlo-maratta-cardinal-antonio-barberini.md)；书中位置 | S1 |
