---
title: 多梅尼科·切拉托（Domenico Cerato）
name_en: Domenico Cerato
type: person
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980;
  ...
  sentence_summary: 图版63将其列为《Prà广场整治原始方案》的创作者。
  original_quotes:
  - source_span: lines 147–147
    text: '63 Domenico Cerato: Original proposals for reclaiming Prato della Valle'
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/00_05_List_of_Plates.md
    source_span: lines 147–147; 章前：图版目录；印刷页xvi
- citation: Treccani, Cerato, Domenico, Enciclopedia on line. https://www.treccani.it/enciclopedia/domenico-cerato/.
    Accessed 2026-09-15.
  location: 完整短条目；身份、生卒、教学与Prato della Valle整治句
  sentence_summary: 切拉托1715年生，出生地可能为Mason，1792年卒于帕多瓦；1765起在帕多瓦教授建筑，并与A. Memmo合作整治Prato della Valle。
created: '2026-09-14'
updated: '2026-09-15'
...
- relation_type: collaborated_with
  ...
  evidence_ref:
    doc_id: persons-domenico-cerato
    source_file: https://www.treccani.it/enciclopedia/domenico-cerato/
    source_span: 短条目：生卒括注及1765教学、Memmo合作句
  review_status: evidence_backed_relation
  relation_source: explicit
  bidirectional_required: false
  role: 广场整治合作者
  scope: Prato della Valle整治，不把合作改作出资或个人委托
- relation_type: located_at
  target: places/padua.md
  evidence_ref:
    doc_id: persons-domenico-cerato
    source_file: https://www.treccani.it/enciclopedia/domenico-cerato/
    source_span: 短条目：生卒括注及1765教学、Memmo合作句
...
- relation_type: located_at
  ...
  bidirectional_required: false
  role: 整治活动地点
  scope: 与Memmo合作整治广场；不等同方案的实际存放地
---
## 内容

### 描述

**中文：** 多梅尼科·切拉托是建筑师及建筑教师，与安德烈亚·梅莫合作整治帕多瓦Prà广场；本书图版63列出他的整治方案。

**English:** Domenico Cerato was an architect and architecture teacher who worked with Andrea Memmo on the reclamation of Prà della Valle in Padua; his proposals appear in plate 63.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 全名 | Domenico Cerato | S2 |
| 惯用名 | Domenico Cerato | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 出生年 | 1715 | S2 |
| 出生地 | 可能为Mason（Vicenza） | S2 |
| 死亡年 | 1792 | S2 |
| 去世地 | [帕多瓦](../places/padua.md) | S2 |
...
|---|---|
| 建筑师／Architect | S2 |
| 建筑教师／Architecture teacher | S2 |

### 职业与生平履历

| 时间 | 活动 | 证据 |
|---|---|---|
| 1765起 | 在[帕多瓦](../places/padua.md)教授民用建筑 | S2 |
| 日期未载 | 与[安德烈亚·梅莫](andrea-memmo.md)合作整治[Prà广场](../places/pra-della-valle.md) | S2 |
...
|---|---|---|
| 图版63角色 | 创作 | S1 |
| 图版63相关对象 | [Prà广场整治原始方案](../works/domenico-cerato-original-proposals-for-reclaiming-pra-della-valle.md)；创作者 | S1 |

## 关系与证据

### 身份与外部链接

[专业来源记录](https://www.treccani.it/enciclopedia/domenico-cerato/)（S2，身份与所列字段）。
