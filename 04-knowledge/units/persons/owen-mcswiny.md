---
title: 欧文·麦克斯温尼（Owen MacSwinny）
name_en: Owen MacSwinny
type: person
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  ...
  sentence_summary: 图版52a目录将其记为描绘／纪念对象。
  original_quotes:
...
**中文：** 剧作家、剧院经营者和艺术商人，图版52a的肖像人物。

**English:** A playwright, theatrical impresario and art dealer portrayed in plate 52a.
...
| 惯用名 | Owen McSwiny | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
| 馆方规范名 | Owen MacSwinny／欧文·麦克斯温尼 | S2 |
| 别名 | Owen Swinny | S2 |
...
|---|---|---|
| 图版52a角色 | 描绘／纪念对象 | S1 |
| 图版52a相关对象 | [欧文·麦克斯温尼肖像](../works/p-van-bleek-owen-mcswiny.md)；描绘／纪念对象 | S1 |
...
| 生年 | 1676 | S2 |
| 卒年 | 1754 | S2 |
| 身份 | 剧作家／Playwright | S2 |
| 身份 | 剧院经营者／Impresario | S2 |
| 身份 | 艺术商人／Art dealer | S2 |

### 艺术委托

| 字段 | 值 | 证据 |
|---|---|---|
| 约1725–1729年系列中的委托 | [《蒂洛特森大主教寓意纪念墓》](../works/canaletto-allegorical-tomb-to-the-memory-of-archbishop-tillotson.md) | S3末段 |
| 建筑绘制参与者 | [卡纳莱托（Canaletto）](canaletto.md) | S4，正文及图注 |
| 风景绘制参与者 | [奇马罗利（Giovanni Battista Cimaroli）](cimaroli.md) | S4，正文及图注 |
| 人物绘制参与者 | [皮托尼（Giovanni Battista Pittoni）](pittoni.md) | S4，正文及图注 |

## 关系与证据

### 身份与外部链接

[NPG人物mp02907](https://www.npg.org.uk/collections/search/person/mp02907/owen-macswinny-or-swinny)（S2，姓名、身份及肖像索引）。
