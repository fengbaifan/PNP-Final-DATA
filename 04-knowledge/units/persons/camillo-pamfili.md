---
title: "卡米洛·弗朗切斯科·玛丽亚·潘菲利（Camillo Francesco Maria Pamphili）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 6.'
  ...
  sentence_summary: Vasalli 对 Mola／Prince Pamfili 服务争议作证，强调作品仍须正常付酬。
  evidence_ref:
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| → 赞助者／保护人（`patron_of`） | [皮耶尔·弗朗切斯科·莫拉（Pier Francesco Mola）](pier-francesco-mola.md) | Valmontone 雇用、装饰委托和费用分担；离开项目所在地几天亦需许可；角色：雇主、装饰委托人与费用承担方；范围：Valmontone装饰及行动许可语境；证据：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 231–233,308–319,505–519; print pp. 7,9,13 |
| → 赞助者／保护人（`patron_of`） | [古列尔莫·科尔泰塞（Guglielmo Cortese）](guglielmo-cortese.md) | 在 Valmontone 受雇期间，Cortese 离开数日须得到特别许可；角色：Valmontone雇主／保护人；范围：离开数日须获特别许可的服务关系；证据：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 231–233; print pp. 7 |
...
| ← 获其建议（`advised_by`，反向投影） | [温琴佐·阿尔曼尼（Vincenzo Armanni）](vincenzo-armanni-ch1.md) | 未注明日期的信就 Valmontone 别墅装饰提供建议；角色：装饰建议提供者；范围：未注明日期的Valmontone别墅装饰书信；原断言与证据见发出端卡片“温琴佐·阿尔曼尼（Vincenzo Armanni）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 329–330; print pp. 9 |
| ← 委托者（`commissioner_of`，反向投影） | [莫拉的瓦尔蒙托内《四元素》壁画方案（Mola’s Four Elements fresco programme at Valmontone）](../works/mola-four-elements-valmontone.md) | Pamfili 别墅工程，相关付款与材料分担脚注支持委托关系；原断言与证据见发出端卡片“莫拉的瓦尔蒙托内《四元素》壁画方案（Mola’s Four Elements fresco programme at Valmontone）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 308–319,505–519; print pp. 9,13 |
