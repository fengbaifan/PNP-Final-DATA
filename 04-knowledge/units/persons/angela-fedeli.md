---
title: 安杰拉（弗朗切斯科·费代利之姐）（Angela (sister of Francesco Fedeli)）
name_en: Angela (sister of Francesco Fedeli)
type: person
...
**中文：** 弗朗切斯科·费代利（又称马焦托）的姐妹。

**English:** A sister of Francesco Fedeli (detto Maggiotto).

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 规范名 | Angela (sister of Francesco Fedeli) | S1 |
