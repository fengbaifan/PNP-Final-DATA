---
title: 塞巴斯蒂亚诺·孔卡（Sebastiano Conca）
name_en: Sebastiano Conca
type: person
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 被列为克勉十一世时期圣克莱孟堂装饰的入选艺术家。
  original_quotes:
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  sentence_summary: 作者称孔卡1707年抵罗马，七年后才获得首项公共委托。
  original_quotes:
  - source_span: lines 184–184
    text: This criticism must certainly carry much weight, and I have thought about it carefully. In the end, however,
...
**中文：** 被列为克勉十一世时期圣克莱孟堂装饰的入选艺术家。

**English:** He is listed among the artists chosen for the decoration of S. Clemente under Clement XI.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 惯用名 | Sebastiano Conca | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 章前记载 | 被列为克勉十一世时期圣克莱孟堂装饰的入选艺术家。 | S1 |
| 章前记载 | 作者称孔卡1707年抵罗马，七年后才获得首项公共委托。 | S2 |
| 章前参与项目 | [圣克莱孟堂重新装饰](../events/san-clemente-redecoration.md) | S1 |

### 目录身份

| 字段 | 值 | 证据 |
|---|---|---|
| 目录姓名 | Sebastiano Conca | S3 |
