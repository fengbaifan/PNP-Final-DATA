---
title: 朱塞佩·马里亚·克雷斯皮（Giuseppe Maria Crespi）
name_en: Giuseppe Maria Crespi
type: person
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 书后索引定向条目；印刷页未核；OCR L1118–1118
  sentence_summary: 索引列Crespi, Giuseppe Maria并包含xvii页。
  original_quotes:
  - source_span: lines 1118–1118
    text: '    Crespi, Giuseppe Maria, xvii, 166, 169-70, 199,'
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/22_CHP-22Index.md
    source_span: lines 1118–1118; print p. 未核
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 章前；印刷页xvii；OCR L184–184
  sentence_summary: 作者对Crespi与Solimena提出未为罗马主要教堂宫殿完成重要作品或仅旅游访问的析取论述。
  original_quotes:
  ...
  evidence_ref:
    ...
    source_span: lines 184–184; print p. xvii
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 章前；印刷页xiv；OCR L102–102
  sentence_summary: 图版36b以G. M. Crespi列创作者。
  original_quotes:
  ...
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/00_05_List_of_Plates.md
    source_span: lines 102–102; print p. xiv
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 章前；印刷页xiv；OCR L103–103
  sentence_summary: 图版37a以G. M. Crespi列创作者。
  original_quotes:
  ...
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/00_05_List_of_Plates.md
    source_span: lines 103–103; print p. xiv
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 章前；印刷页xiv；OCR L104–104
  sentence_summary: 图版37b以G. M. Crespi列创作者。
  original_quotes:
  ...
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/00_05_List_of_Plates.md
    source_span: lines 104–104; print p. xiv
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this printing 2006).
  location: 章前；印刷页xvi；OCR L156–157
  sentence_summary: 图版67以G. M. Crespi列创作者。
  original_quotes:
...
| 字段 | 值 | 证据 |
|---|---|---|
| 全名 | Giuseppe Maria Crespi | S1 |
| 书中简称 | Crespi | S1 |
| 导言判断 | 未完成重要罗马教堂宫殿委托或仅旅游访问，保留原文析取范围 | S2 |
| 作品 | [梳妆少女（Girl at her toilet）](../works/g-m-crespi-girl-at-her-toilet.md) | S3 |
| 作品 | [画家一家（The Painter's Family）](../works/g-m-crespi-the-painter-s-family.md) | S4 |
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| ← 所创作对象（`creator_of`，反向投影） | [波焦阿卡亚诺集市局部（Detail from Fair at Poggio a Caiano）](../works/g-m-crespi-detail-from-fair-at-poggio-a-caiano.md) | 角色：所据画作作者；范围：图版37b所据画作，书中仅复制局部；不将局部复制品当另件乌菲齐藏品；原断言与证据见发出端卡片“波焦阿卡亚诺集市局部（Detail from Fair at Poggio a Caiano）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；haskell-1980-rev-ed；lines 104–104; 章前：图版目录；印刷页xiv |
| ← 所创作对象（`creator_of`，反向投影） | [梳妆少女（Girl at her toilet）](../works/g-m-crespi-girl-at-her-toilet.md) | 角色：原书署名作者；范围：图版36b／37a各自原书行段；两件作品分别保存；原断言与证据见发出端卡片“梳妆少女（Girl at her toilet）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；haskell-1980-rev-ed；lines 102–102; 章前：图版目录；印刷页xiv |
...
| ← 所创作对象（`creator_of`，反向投影） | [画家一家（The Painter's Family）](../works/g-m-crespi-the-painter-s-family.md) | 角色：原书署名作者；范围：图版36b／37a各自原书行段；两件作品分别保存；原断言与证据见发出端卡片“画家一家（The Painter's Family）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；haskell-1980-rev-ed；lines 103–103; 章前：图版目录；印刷页xiv |
