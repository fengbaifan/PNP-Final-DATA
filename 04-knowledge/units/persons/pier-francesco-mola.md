...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| ← 借入者／借阅者（`borrower_of`，反向投影） | [莫拉借阅的神谱书（题名未明）（Genealogy of the Gods Borrowed by Mola (title unidentified)）](../archives/mola-borrowed-genealogy-gods.md) | Mola 为选择图像内容借阅这部未具题名的神谱；角色：借阅者；范围：为选择图像内容借阅的未具题名神谱；原断言与证据见发出端卡片“莫拉借阅的神谱书（题名未明）（Genealogy of the Gods Borrowed by Mola (title unidentified)）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；patrons-and-painters；lines 312–316; print pp. 9 |
| ← 借入者／借阅者（`borrower_of`，反向投影） | [莫拉借阅的维吉尔注释本（版本未明）（Annotated Virgil Borrowed by Mola (edition unidentified)）](../archives/mola-borrowed-virgil-commentary.md) | Mola 借阅的带注释 Virgil 文本，不指定某部作品或版本；角色：借阅者；范围：带注释的Virgil文本；作品及版本未定；原断言与证据见发出端卡片“莫拉借阅的维吉尔注释本（版本未明）（Annotated Virgil Borrowed by Mola (edition unidentified)）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；patrons-and-painters；lines 312–316; print pp. 9 |
| ← 证词所涉对象（`testimony_subject_of`，反向投影） | [亚历山德罗·瓦萨利（Alessandro Vasalli）](alessandro-vasalli.md) | 在 Mola 与 Pamfili 争议中作证，解释有偿优先服务；角色：争议证人；范围：解释Mola对Pamfili的有偿优先服务；原断言与证据见发出端卡片“亚历山德罗·瓦萨利（Alessandro Vasalli）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；patrons-and-painters；lines 179–185; print pp. 6 |
| ← 受其赞助／保护（`patronized_by`，反向投影） | [卡米洛·弗朗切斯科·玛丽亚·潘菲利（Camillo Francesco Maria Pamphili）](camillo-pamfili.md) | Valmontone 雇用、装饰委托和费用分担；离开项目所在地几天亦需许可；角色：雇主、装饰委托人与费用承担方；范围：Valmontone装饰及行动许可语境；原断言与证据见发出端卡片“卡米洛·弗朗切斯科·玛丽亚·潘菲利（Camillo Francesco Maria Pamphili）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；patrons-and-painters；lines 231–233,308–319,505–519; print pp. 7,9,13 |
| ← 教师（`teacher_of`，反向投影） | [乔瓦尼·博纳蒂（Giovanni Bonatti）](giovanni-bonati.md) | 1662年前后在罗马学习于莫拉；旅行赞助与师承分开；时间：约1662；角色：学生；范围：罗马训练；与旅行赞助分开；原断言与证据见发出端卡片“乔瓦尼·博纳蒂（Giovanni Bonatti）”：[来源](https://www.treccani.it/enciclopedia/bonatti-giovanni-detto-giovannino-del-pio-o-il-ferraresino_(Dizionario-Biografico)/)；dbi-bonatti；本卡 S6；罗马训练段 |
...
| ← 朋友（`friend_of`，反向投影） | [皮埃特罗·泰斯塔（Pietro Testa）](pietro-testa.md) | 角色：朋友；范围：卢卡时期；来源明称Mola为朋友；原断言与证据见发出端卡片“皮埃特罗·泰斯塔（Pietro Testa）”：[来源](https://www.treccani.it/enciclopedia/testa-pietro-detto-il-lucchesino_(Dizionario-Biografico)/)；silvia-bruno-testa-pietro-detto-il-lucchesino-dizionario-biografico-degli-italiani-95-2019；lines 54–57 |
| ← 朋友（`friend_of`，反向投影） | [尼科洛·西莫内利（Niccolò Simonelli）](simonelli.md) | 角色：朋友；范围：本书补记p.401称Mola为Simonelli的friend；原断言与证据见发出端卡片“尼科洛·西莫内利（Niccolò Simonelli）”：[来源](../../../02-sources/02-Markdown/20_CHP-20Postscript.md)；patrons-and-painters；lines 90–91; print p.401 |
