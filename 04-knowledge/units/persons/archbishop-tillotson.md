---
title: 蒂洛特森大主教（Archbishop Tillotson）
name_en: Archbishop Tillotson
type: person
...
**中文：** 图版52b目录将其记为描绘／纪念对象。

**English:** The entry for plate 52b records this entity in the role of portrayed or commemorated subject.
...
|---|---|---|
| 图版52b角色 | 描绘／纪念对象 | S1 |
| 图版52b相关对象 | [蒂洛特森大主教寓意纪念墓](../works/canaletto-allegorical-tomb-to-the-memory-of-archbishop-tillotson.md)；描绘／纪念对象 | S1 |
