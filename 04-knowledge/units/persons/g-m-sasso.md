...
**中文：** 图版58b目录将其记为描绘／纪念对象。

**English:** The entry for plate 58b records this entity in the role of portrayed or commemorated subject.
...
|---|---|---|
| 图版58b角色 | 描绘／纪念对象 | S1 |
| 图版58b相关对象 | [G. M. 萨索肖像](../works/alessandro-longhi-g-m-sasso.md)；描绘／纪念对象 | S1 |
