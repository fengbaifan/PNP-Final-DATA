---
title: "德尔卡尔皮奥侯爵（西班牙驻罗马大使）（Marchese Del Carpio (Spanish ambassador in Rome)）"
name_en: "Marchese Del Carpio (Spanish ambassador in Rome)"
type: person
created: 2026-09-09
updated: 2026-09-10
...
**中文：** 向多位艺术家征集表现绘画各方面的作品的使节赞助人；完整姓名尚未由本章核实。

**English:** The ambassador-patron sought works from several artists representing different aspects of painting. His full name has not been established from chapter 1.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Marchese Del Carpio (Spanish ambassador in Rome) | S1；标题中的语境说明为登记用语 |
