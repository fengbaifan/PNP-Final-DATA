...
**中文：** 获 Emperor Frederick III 授予 Count Palatine 荣衔，作为十七世纪以前艺术家获尊荣的例子。

**English:** Bellini received Count Palatine from Emperor Frederick III, cited as an example of artistic distinction before the seventeenth century.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Gentile Bellini | S1；标题中的语境说明为登记用语 |
| 荣衔 | Count Palatine；Frederick III 授予 | S1，支持范围见各条句意摘要 |
...
**身份配对通过。** 十五世纪威尼斯画家 Gentile Bellini；不是其弟 Giovanni。

[Wikipedia（en）](https://en.wikipedia.org/wiki/Gentile_Bellini) 的 wikibase_item 与 [Wikidata Q290407](https://www.wikidata.org/wiki/Q290407) 的 enwiki sitelink 双向一致；已比较上列身份特征。仅确认该对象身份，不据此接收整页史实、全部 WD 属性或新增关系。
