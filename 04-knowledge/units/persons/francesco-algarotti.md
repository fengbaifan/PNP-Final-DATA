---
title: 弗朗切斯科·阿尔加罗蒂（Francesco Algarotti）
name_en: Francesco Algarotti
type: person
...
- citation: Francis Haskell, Patrons and Painters, revised and enlarged edition (Yale University Press, 1980; this
  ...
  - source_span: lines 22–22
    text: 14 Francesco Algarotti 347
  evidence_ref:
...
**中文：** 艺术赞助人、学者及理论家，委托朋友泰西设计自己的墓。

**English:** An art patron, scholar and theorist who commissioned his friend Tesi to design his tomb.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 惯用名 | Francesco Algarotti | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 章前记载 | 本书第十四章以其为题，图版另列其肖像及墓的图像。 | S1 |
| 图版48d角色 | 描绘／纪念对象 | S2 |
| 图版48d相关对象 | [弗朗切斯科·阿尔加罗蒂肖像](../works/francesco-algarotti.md)；描绘／纪念对象 | S2 |
| 图版60角色 | 描绘／纪念对象 | S3 |
| 图版60相关对象 | [阿尔加罗蒂墓前悼念者](../works/g-volpato-mourners-at-tomb-of-francesco-algarotti-in-pisa.md)；描绘／纪念对象 | S3 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 作品 | [弗朗切斯科·阿尔加罗蒂墓](../works/tomb-of-francesco-algarotti.md) | S4 |
