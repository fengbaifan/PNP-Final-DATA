---
title: 安·萨瑟兰·哈里斯（Ann Sutherland Harris）
name_en: Ann Sutherland Harris
type: person
...
- relation_type: educated_at
  ...
  evidence_ref:
    doc_id: persons-ann-sutherland-harris
...
- relation_type: employed_by
  target: institutions/university-of-pittsburgh.md
  evidence_ref:
    doc_id: persons-ann-sutherland-harris
    source_file: https://www.haa.pitt.edu/people/ann-sutherland-harris
    source_span: 完整教师页面：研究、教育、项目与出版清单；未下载CV
...
**中文：** 研究欧洲晚期文艺复兴与17世纪艺术的艺术史家、教授，为本书新版提供帮助。

**English:** An art historian and professor specializing in late Renaissance and seventeenth-century European art, thanked for helping with the revised edition.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 惯用名 | Ann Sutherland Harris | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
| 任职机构 | [匹兹堡大学](../institutions/university-of-pittsburgh.md) | S2，校方教师履历 |
| 职位 | 教授／Professor | S2 |
| 研究范围 | 欧洲晚期文艺复兴与17世纪艺术、艺术家素描 | S2 |

### 教育

| 字段 | 值 | 证据 |
|---|---|---|
| 博士学习机构 | [考陶尔德艺术学院](../institutions/courtauld-institute-of-art.md) | S2 |

### 著述

| 字段 | 值 | 证据 |
|---|---|---|
| 专著 | [安德烈亚·萨基（Andrea Sacchi）](../archives/harris-andrea-sacchi-1977.md) | S2，1977年 |

## 关系与证据

### 身份与外部链接

[匹兹堡大学教师履历](https://www.haa.pitt.edu/people/ann-sutherland-harris)（S2）。
