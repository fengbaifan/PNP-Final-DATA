...
- relation_type: uses_procedure
  target: procedures/exhibition-self-promotion.md
  note: 展览期间组织喝彩者等宣传行为，依据章内传记转述。
  evidence_ref:
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 11.'
  location: 第一章；印刷页 11；OCR L382–389
  sentence_summary: Rosa 抵触依题作画但仍接受朋友建议。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 382–389; print pp. 11
  original_quotes:
  - source_span: lines 382–389
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 15.'
  location: 第一章；印刷页 15；OCR L603–609
  sentence_summary: 现画销售与展览手段，重视大历史画。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 603–609; print pp. 15
  original_quotes:
  - source_span: lines 603–609
    text: 'work to commission, had his studio full of pictures ready for sale, both large and small,
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 22.'
  location: 第一章；印刷页 22；OCR L905–926
  sentence_summary: 自我形象、展览与喝彩者的宣传策略。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 905–926; print pp. 22
  original_quotes:
  - source_span: lines 905–926
    text: 'we must consider briefly some aspects of the career of Salvator Rosa, the painter who
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 22, 23.'
  location: 第一章；印刷页 22, 23；OCR L927–947,952–970
  sentence_summary: 拒预付、按成品质量定价与灵感主张；作者解释不等于无经济依赖。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
    source_span: lines 927–947,952–970; print pp. 22, 23
  original_quotes:
  - source_span: lines 927–947
    text: 'But Salvator Rosa was engaged in a yet more serious battle. He, alone among his
  ...
  - source_span: lines 952–970
    text: 'generally held conception, the implications of which have already been examined, that
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 23.'
  ...
  sentence_summary: de Rosis、Ferri、Luti 的脚注限定“没有真正追随者”。
  evidence_ref:
    doc_id: patrons-and-painters
    source_file: 02-sources/02-Markdown/01_CHP-1.md
  ...
  - source_span: lines 971–980
    text: '1 Letter from Giuseppe de Rosis to Don. Antonio Ruffo, dated 22 September 1663, published by
...
- citation: Wikipedia (en), Salvator Rosa, revision 1370459061. https://en.wikipedia.org/wiki/Salvator_Rosa. Accessed 2026-09-10.
...
**中文：** 画家，利用展览、喝彩者和工作室现画销售扩大选择空间。拒收预付并主张按成品质量定价，是本章依据书信与传记提炼的具体行为。

不愿依委托作画不等于拒绝朋友建议，宣称只为满足自己也不是没有经济依赖的证明。“没有真正追随者”须与章末 Ferri、Luti 的局部相似做法并读；与 Schildersbent 没有成员证据。

**English:** Rosa used exhibitions, supporters and studio stock, rejected advances and argued for prices based on finished quality. Refusing commissions did not preclude friends' advice or prove economic independence. His lack of real followers must be read alongside Ferri's and Luti's partial parallels; Schildersbent membership is unproved.

### 已有信息

| 项目 | 内容 | 依据 |
|---|---|---|
| 名称／对应英文 | Salvator Rosa | S1、S2、S3、S4、S5 |
| 创作交易策略 | 展览、喝彩、存画销售、拒收预付、质量定价 | S1、S2、S3、S4、S5 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 油画 | [雷古鲁斯之死](../works/salvator-rosa-the-death-of-regulus.md)，约1650–1652 | S13 |
| 准备稿 | [雷古鲁斯之死准备稿](../works/rosa-regulus-study-princeton.md)，约1652 | S12 |
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| → 采用程序（`uses_procedure`） | [展览售画与自我宣传（Exhibiting paintings and self-promotion）](../procedures/exhibition-self-promotion.md) | 展览期间组织喝彩者等宣传行为，依据章内传记转述；证据：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 917–926; print pp. 22 |
| ← 所创作对象（`creator_of`，反向投影） | [雷古鲁斯之死准备稿（Study for the Death of Atilius Regulus）](../works/rosa-regulus-study-princeton.md) | 时间：约1652；角色：素描作者；范围：x1948-610单件准备稿；原断言与证据见发出端卡片“雷古鲁斯之死准备稿（Study for the Death of Atilius Regulus）”：[来源](https://artmuseum.princeton.edu/art/collections/objects/8060)；src-574c245a5df7710c；Maker、Dates |
| ← 所创作对象（`creator_of`，反向投影） | [与少女嬉戏的萨提尔（Satyrs Carousing with Maidens）](../works/salvator-rosa-satyrs-carousing-with-maidens.md) | 时间：known by the attached sale note of 1663-06-02; no exact execution date established；角色：painter named in the attached note; the lot catalogue also reports a strengthened signature ‘Rosa’；范围：painting described in the sale note; relationship to the surviving auction canvas remains a candidate match；原断言与证据见发出端卡片“与少女嬉戏的萨提尔（Satyrs Carousing with Maidens）”：[来源](https://archive.org/stream/bollettinodarte10italuoft/bollettinodarte10italuoft_djvu.txt)；printed p. 169, footnote (1) identifies the attached note as made by Salvator Rosa; the note describes this painting |
| ← 所创作对象（`creator_of`，反向投影） | [雷古鲁斯之死（The Death of Regulus）](../works/salvator-rosa-the-death-of-regulus.md) | 时间：本书所述时点；角色：画家；范围：本书图版23b油画；区别普林斯顿准备稿；原断言与证据见发出端卡片“雷古鲁斯之死（The Death of Regulus）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；haskell-1980-rev-ed；lines 76–76; 章前：图版目录；印刷页xiii |
| ← 为其所涉对象（`subject_of`，反向投影） | [朱塞佩·德·罗西斯致安东尼奥·鲁福的信（1663-09-22）（Letter from Giuseppe de Rosis to Antonio Ruffo (1663-09-22)）](../archives/de-rosis-ruffo-letter-1663.md) | 代理人在信中评价罗萨宁愿挨饿也不降低作品声誉；原断言与证据见发出端卡片“朱塞佩·德·罗西斯致安东尼奥·鲁福的信（1663-09-22）（Letter from Giuseppe de Rosis to Antonio Ruffo (1663-09-22)）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 957–972; print pp. 23 |
...
[Princeton x1948-610](https://artmuseum.princeton.edu/art/collections/objects/8060)（S12，准备稿）；[VMFA 59.15图像元数据转存](https://commons.wikimedia.org/w/index.php?title=File:Rosa_-_The_Death_of_Regulus,_ca._1650-1652.jpg&oldid=1018278172)（S13，油画）。

- [Q359421](https://www.wikidata.org/wiki/Q359421)
- [Wikipedia（en）](https://en.wikipedia.org/wiki/Salvator_Rosa)

[第一章既有处理依据](../../../03-processing/patrons-and-painters-chp-1/process/knowledge.md#rev-072-persons-salvator-rosa)
