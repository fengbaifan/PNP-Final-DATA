...
- citation: "Wikidata, Q214074, revision 2539087728. https://www.wikidata.org/wiki/Q214074. Accessed 2026-09-10."
  ...
  sentence_summary: "Claude Gellée／Claude Lorrain，洛林出身、主要在意大利活动的画家。"
- citation: "Wikipedia (en), Claude Lorrain, revision 1373831548. https://en.wikipedia.org/wiki/Claude_Lorrain Accessed 2026-09-11."
  location: "全文27928字符；章节：Biography、Style and subjects、Influences、Early works、Figures and other non-landscape elements、Figures、Architecture、Shipping、Critical assessment and legacy、Claude glass、Selected works、See also"
...
| 出生地 | 沙马涅 | Wikidata P19；有参考 |
| 去世地 | 罗马 | Wikidata P20；有参考 |
| 国籍／公民身份 | 洛林公国 | Wikidata P27；有参考 |
| 身份／职业标签 | 畫家；素描家；版畫家 | Wikidata P106；有参考；未列参考 |
...
| 方向与关系 | 关联知识元 | 语境与证据 |
|---|---|---|
| ← 所创作对象（`creator_of`，反向投影） | [有队列的德尔斐景观（View of Delphi with a Procession）](../works/claude-view-of-delphi-with-a-procession.md) | 角色：原书署名作者；范围：图版19b；德尔斐为图像地点，Robert A.Waller Fund为收藏资助线索；原断言与证据见发出端卡片“有队列的德尔斐景观（View of Delphi with a Procession）”：[来源](../../../02-sources/02-Markdown/00_05_List_of_Plates.md)；haskell-1980-rev-ed；lines 72–72; 章前：图版目录；印刷页xiii |
| ← 为其所涉对象（`subject_of`，反向投影） | [雅各布·萨尔维亚蒂致莱奥波尔多·德·美第奇的信（1662-07-22）（Letter from Jacopo Salviati to Leopoldo de’ Medici (1662-07-22)）](../archives/salviati-medici-letter-1662.md) | 信件讨论购求及估价的对象是克洛德的作品；没有足够端点识别具体画作；原断言与证据见发出端卡片“雅各布·萨尔维亚蒂致莱奥波尔多·德·美第奇的信（1662-07-22）（Letter from Jacopo Salviati to Leopoldo de’ Medici (1662-07-22)）”：[来源](../../../02-sources/02-Markdown/01_CHP-1.md)；haskell-1980-rev-ed；lines 537–540,565–566; print pp. 14 |
