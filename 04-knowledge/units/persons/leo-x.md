...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 16.'
  ...
  sentence_summary: Haskell 以其时代与后来的实用社会相比，讨论艺术自足性及创作者神秘光环。该论述不等同量化历史事实。
  evidence_ref:
...
- citation: "Wikidata, Q49237, revision 2540186940. https://www.wikidata.org/wiki/Q49237. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "Giovanni de’ Medici，1513–1521 年在位教皇，与文艺复兴比较语境相容。"
- citation: "Wikipedia (en), Pope Leo X, revision 1368372595. https://en.wikipedia.org/wiki/Pope_Leo_X Accessed 2026-09-11."
  location: "全文31792字符；章节：Early life、Cardinal、Pope、Papal election、War of Urbino、Plans for a crusade、Protestant Reformation、Other activities、Consistories、Canonizations、Final years、Character, interests and talents"
...
**中文：** Haskell 以其时代与后来的实用社会相比，讨论艺术自足性及创作者神秘光环。该论述不等同量化历史事实。

**English:** Haskell contrasts Leo X's age with a later practical society when discussing artistic self-sufficiency and the creator's mystique. This is historical interpretation, not a quantified finding.
...
| 身份／职业标签 | 罗马天主教神父；Catholic priest | Wikidata P106；有参考 |
| 父亲 | 洛伦佐·德·美第奇 | Wikidata P22；未列参考 |
| 母亲 | 克拉丽斯·奥尔西尼 | Wikidata P25；未列参考 |
