---
title: 拉里萨·萨尔米娜（Larissa Salmina）
name_en: Larissa Salmina
type: person
...
**中文：** 艺术史策展人、哈斯克尔的配偶，也是本书献辞中的拉里萨。

**English:** An art curator, Haskell’s spouse, and the Larissa named in the book’s dedication.
...
| 惯用名 | Larissa | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
| 全名 | Larissa Salmina／拉里萨·萨尔米娜 | S2，p.232 |
...
| 字段 | 值 | 证据 |
|---|---|---|
| 1962年职务 | 威尼斯素描策展人／Curator of Venetian drawings | S2，p.232 |
| 任职机构 | [艾尔米塔什博物馆](../institutions/hermitage-museum.md) | S2，p.232 |

### 亲缘

| 字段 | 值 | 证据 |
|---|---|---|
| 配偶 | [弗朗西斯·詹姆斯·赫伯特·哈斯克尔](francis-haskell.md)；1965年结婚 | S2，p.232 |

### 相识记录

| 字段 | 值 | 证据 |
|---|---|---|
| 1962年相识地点 | [威尼斯](../places/venice.md) | S2，p.232 |
| 介绍人 | [亚历山德罗·贝塔尼奥](alessandro-bettagno.md) | S2，p.232 |

## 关系与证据

### 身份与外部链接

[British Academy Haskell传记p.232](https://www.thebritishacademy.ac.uk/documents/366/115p227.pdf)（S2，Larissa Salmina及婚姻身份）。
