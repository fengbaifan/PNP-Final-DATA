...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 3.'
  ...
  sentence_summary: Gregory XV 在位 1621–1623，为 Urban VIII 之前的赞助先例。
  evidence_ref:
...
- citation: "Wikidata, Q132692, revision 2522319902. https://www.wikidata.org/wiki/Q132692. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "Alessandro Ludovisi／Gregory XV，1621–1623 年教皇；不是侄辈 Ludovico。"
- citation: 'Wikipedia (en), Pope Gregory XV, revision 1362442411. https://en.wikipedia.org/wiki/Pope_Gregory_XV. Accessed 2026-09-10.'
  location: 'REV-045：信息框、Biography（全部小节）、图注、Notes、References、Sources、Further reading 及职务表；对象页全文已读，所引原件未读'
  sentence_summary: '补充原名、教育和任职、亲缘与艺术交往线索；文章带需补引文提示，具体任命日期、家族授衔及死因不能整体采信。'
- citation: 'Wikidata, Q132692, revision 2522319902. https://www.wikidata.org/wiki/Q132692. Accessed 2026-09-10.'
  location: 'REV-045：实际读取生卒、地点、性别、父母、教育、任职与政治归属字段；保留 rank、时间精度、历法、限定词和引用'
  sentence_summary: '生卒日期、父母、任职已按来源交叉判断；主教任职起始不能混同任命与祝圣，教育机构现代标签不覆盖历史校名。'
- citation: 'Alexander Koller, GREGORIO XV, papa, Dizionario Biografico degli Italiani 59 (2002). https://www.treccani.it/enciclopedia/papa-gregorio-xv_(Dizionario-Biografico)/ Accessed 2026-09-10.'
  location: '生平开篇、教育／任职段、选举与加冕段、艺术家段、逝世与安葬段、书目；本轮定向采用，所引档案和全部研究书未读'
  sentence_summary: '传记支持父母与学习顺序，区分选举和加冕；与 Wikipedia 存若干任职、典礼日期异文，分期安葬不写成一次直接入葬。'
...
**中文：** 格列高利十五世，原名亚历山德罗·卢多维西（Alessandro Ludovisi，1554–1623），是出身博洛尼亚、于 1621–1623 年在位的教皇。第一章将他与侄子卢多维科分别叙述，并讨论其当选对多梅尼基诺返罗马的作用及其对圣路加学院章程的确认。外部资料补入教育、任职与亲缘，具体日期异文保留。

**English:** Gregory XV, born Alessandro Ludovisi (1554–1623), was a pope from Bologna who reigned from 1621 to 1623. Chapter 1 distinguishes him from his nephew Ludovico and discusses his election in relation to Domenichino's return to Rome and his confirmation of the Accademia di San Luca's statutes. External sources supply education, offices and family information; conflicting dates remain explicit.

### 姓名与称号

| 字段 | 值 | 证据 |
|---|---|---|
| 世俗全名 | Alessandro Ludovisi／亚历山德罗·卢多维西（中文音译） | S8 开篇；S9 |
| 教皇名／通行名 | Gregory XV／格列高利十五世 | S1–S3、S9 |
| 意大利语名 | Gregorio XV | S6 导言；S8 题名 |
| 拉丁语名 | Gregorius XV | S6 导言 |
| 本章称谓 | Cardinal Ludovisi（卢多维西枢机） | S2；不是侄子 Ludovico |
| 本人贵族头衔／昵称 | 尚未核定 | 父亲的伯爵或亲属的公爵头衔不移给本人 |

### 基本信息

| 字段 | 值 | 证据 |
|---|---|---|
| 性别 | 男性（Male） | S7 性别字段，所引原规范记录未另读 |
| 出生日期 | 1554-01-09（按传记日期，未作历法换算） | S8 开篇；S7 为儒略历值 |
| 去世日期 | 1623-07-08 | S8 末年；S9；S7 |
| 出生地 | [博洛尼亚（Bologna）](../places/bologna.md) | S8–S9；S7 |
| 去世地 | [罗马（Rome）](../places/rome.md)，奎里纳莱宫 | S8；S6；S7 支持城市层级 |
| 政治活动范围 | 教皇国（Papal States） | S6、S8；不填作现代意大利国籍 |
| 配偶／子女 | 本轮未核 | 职位或字段缺失不能证明不存在 |
...
| 时间 | 机构／地点 | 事项 | 证据 |
|---|---|---|---|
| 1567 年秋起，约两年 | 罗马 Collegio germanico | 与兄长入学 | S8 教育段 |
| 1569 起 | 罗马 Collegio romano | 学习哲学与神学 | S8；保留历史校名 |
| 1571 起 | 博洛尼亚 | 开始法律学习 | S8 |
| 1575-06-04 | 博洛尼亚大学（University of Bologna） | 获教会法与民法双法学位（utriusque iuris） | S6；S8；S7 支持就学机构 |
...
| 1616-09-19 | 晋升枢机 | 教廷 | S6–S8；与领帽及领衔教堂分开 |
| 1618-12-03 | 获领衔教堂 | Santa Maria in Traspontina | S6；S8 |
| 1621-02-09 | 当选教皇 | 教廷 | S8；S9 开始栏；S7 |
| 1621-02-14 | 加冕 | 教廷 | S8；S6；S9 与当选日并列 |
| 1621 | 确认学院章程 | [圣路加学院](../institutions/accademia-di-san-luca.md) | S3，第一章 p. 17，L690–691 |
| 1621–1623 | 在位期间的艺术活动 | 多梅尼基诺、圭尔奇诺 | S2；S8 艺术家段；具体委托分别处理 |
| 1623-07-08 | 在位终止／去世 | 罗马 | S9；S8 |

### 艺术活动与相关作品

| 对象 | 本人角色 | 信息与限定 | 证据 |
|---|---|---|---|
| [多梅尼基诺](domenichino.md) | 本章所述教皇赞助环境中的人物 | 其当选吸引同乡画家返回罗马 | S2，p. 4，L65–83 |
| [圭尔奇诺](guercino.md) | 艺术赞助关系线索 | 画家在其在位时于罗马工作；委托不能与枢机侄子的活动合并 | S6；S8 |
| 圭尔奇诺所绘教皇肖像 | 被描绘者 | S6 图注列 1622、Getty 收藏；本轮未核具体实物记录，不新建作品 KU | S6 图注 |

### 研究文献

| 文献 | 责任者 | 出版信息 | 阅读状态 |
|---|---|---|---|
| “GREGORIO XV, papa” | Alexander Koller，作者 | *Dizionario Biografico degli Italiani* 59，2002 | S8 对象传记已读；所引原档未读 |
| “Pope Gregory XV” | Michael Ott，作者 | *Catholic Encyclopedia* 7，1910 | S6 引用／文本来源线索；原条目未另读 |
| *Päpstliches Zeremoniell in der Frühen Neuzeit – Das Diarium des Zeremonienmeisters Paolo Alaleone de Branca während des Pontifikats Gregors XV. (1621–1623)* | Günther Wassilowsky、Hubert Wolf；具体编辑责任待核 | Münster：Rhema，2007；ISBN 978-3-930454-80-8 | S6 Further reading；出版社及原书未读 |

### 本章相关内容

本章 p. 3 将 1621–1623 年教皇在位作为乌尔班八世之前的赞助背景；p. 4 区分当选的卢多维西枢机和侄辈，联系到多梅尼基诺重返罗马；p. 17 说明学院章程确认。三个来源定位各有支持范围，不以一个出处证明全部生平。
