---
title: 杰罗姆·班克斯（Jerome Bankes）
name_en: Jerome Bankes
type: person
...
**中文：** 图版30a目录将其记为描绘／纪念对象。

**English:** The entry for plate 30a records this entity in the role of portrayed or commemorated subject.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 惯用名 | Jerome Bankes | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
