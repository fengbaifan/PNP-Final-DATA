---
title: 马尔科·皮泰里（Marco Pitteri）
name_en: Marco Pitteri
type: person
...
**中文：** 图版48a将其列为《弗拉米尼奥·科尔内尔》的创作者。

**English:** The entry for plate 48a lists this person for the creation of Flaminio Corner.

### 名称

| 字段 | 值 | 证据 |
|---|---|---|
| 惯用名 | Marco Pitteri | S1 |
| 中文名性质 | 项目工作译名 | 项目命名 |
...
|---|---|---|
| 图版48a角色 | 创作 | S1 |
| 图版48a相关对象 | [弗拉米尼奥·科尔内尔肖像](../works/marco-pitteri-flaminio-corner.md)；创作者 | S1 |
