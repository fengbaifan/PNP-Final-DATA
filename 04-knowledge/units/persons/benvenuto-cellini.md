---
title: "本韦努托·切利尼（Benvenuto Cellini）"
...
- citation: 'Francis Haskell, Patrons and Painters, revised and enlarged ed. (New Haven and London: Yale University Press, 1980; this printing 2006), ch. 1, pp. 16.'
  location: 第一章；印刷页 16；OCR L634–635
  sentence_summary: 其自传被 Haskell 用作天才行为得到宽容的叙事参照，不表示该书已在本次阅读全文。
  evidence_ref:
...
- citation: "Wikidata, Q190116, revision 2539677897. https://www.wikidata.org/wiki/Q190116. Accessed 2026-09-10."
  location: "labels／descriptions／P31／适用身份字段及 enwiki sitelink；判断范围见正文"
  sentence_summary: "十六世纪佛罗伦萨金匠、雕塑家和自传作者；人物与自传分开。"
- citation: "Wikipedia (en), Benvenuto Cellini, revision 1372874984. https://en.wikipedia.org/wiki/Benvenuto_Cellini Accessed 2026-09-11."
  location: "全文23922字符；章节：Biography、Youth、Work in Rome、Ferrara and France、Final return to Florence and death、Artwork、Statues、Decorative art and portraiture、Lost works、Drawings and sketches、In literature, music and film、Autobiography"
...
**中文：** 其自传被 Haskell 用作天才行为得到宽容的叙事参照，不表示该书已在本次阅读全文。

**English:** Haskell invokes Cellini's autobiography in discussing indulgence towards genius. This does not mean the autobiography has been fully read for this project.
...
| 国籍／公民身份 | 佛罗伦萨共和国；佛羅倫斯公國 | Wikidata P27；未列参考 |
| 身份／职业标签 | 雕塑家；作家；币章雕刻家；自传作者；建筑绘图员；金匠；美術史學家；銀匠 | Wikidata P106；有参考 |
| 配偶 | Piera Parigi | Wikidata P26；未列参考 |
