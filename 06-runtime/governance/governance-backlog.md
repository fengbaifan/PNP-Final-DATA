...
| ID | Issue | Scope | Status |
|---|---|---|---|
| OPP-ISOLATED | isolated units may warrant relation review | 76 | candidate_opportunity |
...
| C-CONTENT | mechanical content findings absent | 2026-09-12 | completed |
