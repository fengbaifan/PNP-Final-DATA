...
| ID | Issue | Scope | Status |
|---|---|---|---|
| RD-SINGLE_SOURCE_UNITS | knowledge units supported by one source | 190 | research_debt |

## Candidate opportunities (not accepted knowledge)

| ID | Issue | Scope | Status |
|---|---|---|---|
| OPP-ISOLATED | isolated units may warrant relation review | 147 | candidate_opportunity |
