...
|---|---|---|---|
| RD-SINGLE_SOURCE_UNITS | knowledge units supported by one source | 263 | research_debt |

## Candidate opportunities (not accepted knowledge)

| ID | Issue | Scope | Status |
|---|---|---|---|
| OPP-ISOLATED | isolated units may warrant relation review | 498 | candidate_opportunity |
